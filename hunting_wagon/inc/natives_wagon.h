...
static void _0xA3DB37EDF9A74635(Player player, Entity entity, int p2, int p3, BOOL p4) { invoke<Void>(0xA3DB37EDF9A74635, player, entity, p2, p3, p4); }
...
static BOOL _0x835F131E7DC8F97A(Entity entity, float p1, Any p2) { return invoke<BOOL>(0x835F131E7DC8F97A, entity, p1, p2); }
...
static BOOL _0x9A100F1CF4546629(Ped p0) { return invoke<BOOL>(0x9A100F1CF4546629, p0); }
static BOOL _0xC346A546612C49A9(Ped p0) { return invoke<BOOL>(0xC346A546612C49A9, p0); }
...
static Vector3 GET_ENTITY_VELOCITY(Entity entity, int p1) { return invoke<Vector3>(0x4805D2B1D8CF94A9, entity, p1); }
...
static BOOL _0x9587913B9E772D29(Ped p0, BOOL p1) { return invoke<BOOL>(0x9587913B9E772D29, p0, p1); }
...
static BOOL IS_ENTITY_IN_VOLUME(Any p0, Any p1, BOOL p2, Any p3) { return invoke<BOOL>(0x5A5526BC09C06623, p0, p1, p2, p3); }
...
static void SET_ENTITY_COMPLETELY_DISABLE_COLLISION(Entity entity, BOOL p1, BOOL p2) { invoke<Void>(0xE0580EC84813875A, entity, p1, p2); }
...
static BOOL FIND_ANIM_EVENT_PHASE(char* animDictionary, char* animName, char* p2, float* p3, int* p4) { return invoke<BOOL>(0x42718CC559BD7776, animDictionary, animName, p2, p3, p4); }
static void FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(Entity entity, BOOL p1) { invoke<Void>(0x4C9E96473D4F1A88, entity, p1); }
static float _0x627520389E288A73(int p0, char* p1, char* p2) { return invoke<float>(0x627520389E288A73, p0, p1, p2); }
...
static void _SET_PED_ONTO_MOUNT(Ped ped, Ped mount, int seatIndex, BOOL p3) { invoke<Void>(0x028F76B6E78246EB, ped, mount, seatIndex, p3); }
...
static int _0x88EFFED5FE8B0B4A(Ped ped) { return invoke<Any>(0x88EFFED5FE8B0B4A, ped); }
...
static BOOL _0x101B45C5F56D970F(int* p0, Ped p1, int p2, int p3) { return invoke<BOOL>(0x101B45C5F56D970F, p0, p1, p2, p3); }
...
static BOOL _IS_PED_OPENING_A_DOOR(Ped ped) { return invoke<BOOL>(0x26AF0E8E30BD2A2C, ped); }
...
static void SET_PED_HIGHLY_PERCEPTIVE(Ped ped, BOOL p1) { invoke<Void>(0x52D59AB61DDC05DD, ped, p1); }
...
static BOOL SET_FORMATION_POSITIONS_TARGET_RADIUS(Any p0, float p1) { return invoke<BOOL>(0x7CC7D3B7AF7FB71F, p0, p1); }
...
static BOOL _0x268B3AEBF032A88D(Ped ped) { return invoke<BOOL>(0x268B3AEBF032A88D, ped); }
static void _0xC17A94CC8FC3C61A(Any p0, Any p1, float p2, float p3, float p4) { invoke<Void>(0xC17A94CC8FC3C61A, p0, p1, p2, p3, p4); }
static void _SET_PED_SCALE(Ped ped, float scale) { invoke<Void>(0x25ACFC650B65C538, ped, scale); }
...
static void _DISABLE_AMBIENT_LOOK_AT_REQUESTS(Any p0, Any p1) { invoke<Void>(0x80038740C96AD17F, p0, p1); }
...
static BOOL IS_PED_PERFORMING_MELEE_ACTION(Ped ped, Any p1, Any p2) { return invoke<BOOL>(0xDCCA191DF9980FD7, ped, p1, p2); }
...
static BOOL IS_PED_HEADING_TOWARDS_POSITION(Any p0, float p1, float p2, float p3, float p4) { return invoke<BOOL>(0xFCF37A457CB96DC0, p0, p1, p2, p3, p4); }
...
static Entity _GET_PED_CARRIABLE_ENTITY(Ped ped) { return invoke<Any>(0xD806CD2A4F2C2996, ped); }
...
static void _0x5653AB26C82938CF(Ped ped, int p1, float p2) { invoke<Void>(0x5653AB26C82938CF, ped, p1, p2); }
...
static void _0xCC8CA3E88256E58F(Ped ped, BOOL p1, BOOL p2, BOOL p3, BOOL p4, BOOL p5) { invoke<Void>(0xCC8CA3E88256E58F, ped, p1, p2, p3, p4, p5); }
...
static void _0x1902C4CFCC5BE57C(Ped ped, Hash hash) { invoke<Void>(0x1902C4CFCC5BE57C, ped, hash); }
...
static void SET_PED_VISIBLE(Ped p0, BOOL p1) { invoke<Void>(0x283978A15512B2FE, p0, p1); }
static Any _0x10C70A515BC03707(Any p0) { return invoke<Any>(0x10C70A515BC03707, p0); }
static void _SET_PED_OUTFIT_PRESET(Ped ped, int presetId, BOOL p2) { invoke<Void>(0x77FF8D35EEC6BBC4, ped, presetId, p2); }
...
static void _0x437C08DB4FEBE2BD(Ped p0, char* p1, float p2, int p3) { invoke<Void>(0x437C08DB4FEBE2BD, p0, p1, p2, p3); }
...
static BOOL IS_SEAT_WARP_ONLY(Vehicle vehicle, int seatIndex) { return invoke<BOOL>(0x7892685BF6D9775E, vehicle, seatIndex); }
...
static void SET_DISABLE_RANDOM_TRAINS_THIS_FRAME(BOOL toggle) { invoke<Void>(0xD4288603E8766FF7, toggle); }
static void SET_VEHICLE_DOORS_LOCKED(Vehicle vehicle, int doorLockStatus) { invoke<Void>(0x96F78A6A075D55D9, vehicle, doorLockStatus); }
static void _SET_VEHICLE_DOOR_DESTROY_TYPE(Vehicle vehicle, int doorIndex, int destroyType) { invoke<Void>(0xA9F1D75195CC40F6, vehicle, doorIndex, destroyType); }
...
static void _SET_BOAT_FROZEN_WHEN_ANCHORED(Vehicle vehicle, BOOL p1, BOOL p2) { invoke<Void>(0x286771F3059A37A7, vehicle, p1, p2); }
static void _0x75B49ACD73617437(Vehicle vehicle, BOOL p1) { invoke<Void>(0x75B49ACD73617437, vehicle, p1); }
static void _SET_BOAT_ANCHOR_BUOYANCY_COEFFICIENT(Vehicle vehicle, float p1) { invoke<Void>(0xE3261532550D6A9F, vehicle, p1); }
static void _SET_BOAT_EXPLODES_ON_WRECKED_ACTION(Vehicle vehicle, BOOL toggle) { invoke<Void>(0x62A6D317A011EA1D, vehicle, toggle); }
...
static int _0xA8BA0BAE0173457B(Ped p0, int p1) { return invoke<int>(0xA8BA0BAE0173457B, p0, p1); }
...
static void CLEAR_LAST_DRIVEN_VEHICLE() { invoke<Void>(0x0EFC5DC62E67609B); }
...
static void COPY_VEHICLE_DAMAGES(Vehicle vehicle, Vehicle vehicle2) { invoke<Void>(0xDBC28A8C683CD80B, vehicle, vehicle2); }
...
static void SET_VEHICLE_INACTIVE_DURING_PLAYBACK(Vehicle vehicle, BOOL p1) { invoke<Void>(0x4EA71B4C9DB3C3F1, vehicle, p1); }
...
static BOOL _0xA19447D83294E29F(Ped p0, int* p1, int* p2) { return invoke<BOOL>(0xA19447D83294E29F, p0, p1, p2); }
...
static void _0x31F343383F19C987(Vehicle p0, float p1, BOOL p2) { invoke<Void>(0x31F343383F19C987, p0, p1, p2); }
...
static void DOOR_SYSTEM_SET_DOOR_STATE(Hash doorHash, int limit) { invoke<Void>(0x6BAB9442830C7F53, doorHash, limit); }
static int DOOR_SYSTEM_GET_DOOR_STATE(Hash doorHash) { return invoke<int>(0x160AA1B32F6139B8, doorHash); }
static void DOOR_SYSTEM_SET_AUTOMATIC_RATE(Hash doorHash, float p1) { invoke<Void>(0x03C27E13B42A0E82, doorHash, p1); }
static void DOOR_SYSTEM_SET_AUTOMATIC_DISTANCE(Hash doorHash, float heading) { invoke<Void>(0x9BA001CB45CBF627, doorHash, heading); }
static void _0xB3B1546D23DF8DE1(Any p0, float p1, float p2, float p3, BOOL p4) { invoke<Void>(0xB3B1546D23DF8DE1, p0, p1, p2, p3, p4); }
static void DOOR_SYSTEM_SET_OPEN_RATIO(Hash doorHash, float ajar, BOOL p2) { invoke<Void>(0xB6E6FBA95C7324AC, doorHash, ajar, p2); }
...
static Object GET_RAYFIRE_MAP_OBJECT(float x, float y, float z, float rotation, char* name) { return invoke<Object>(0xB48FCED898292E52, x, y, z, rotation, name); }
static void SET_STATE_OF_RAYFIRE_MAP_OBJECT(int handle, int state) { invoke<Void>(0x5C29F698D404C5E1, handle, state); }
static int GET_STATE_OF_RAYFIRE_MAP_OBJECT(int handle) { return invoke<Any>(0x899BA936634A322E, handle); }
static BOOL DOES_RAYFIRE_MAP_OBJECT_EXIST(int handle) { return invoke<BOOL>(0x52AF537A0C5B8AAD, handle); }
...
static void _0x94F3D956BFAEAE18(Any p0, Any p1, Any p2) { invoke<Void>(0x94F3D956BFAEAE18, p0, p1, p2); }
static void _SET_LOCAL_PLAYER_CAN_USE_PICKUPS_WITH_THIS_MODEL(Hash modelHash, BOOL toggle) { invoke<Void>(0x88EAEC617CD26926, modelHash, toggle); }
static void BLOCK_PICKUP_FROM_PLAYER_COLLECTION(Any p0, Any p1) { invoke<Void>(0xB8F5062070BB6DBD, p0, p1); }
static void SET_PICKUP_NOT_LOOTABLE(Any p0, Any p1) { invoke<Void>(0x92E87F60F21A0C3A, p0, p1); }
static void _0x1F5E07E14A86FAFC(Any p0) { invoke<Void>(0x1F5E07E14A86FAFC, p0); }
...
static void SET_PICKUP_UNCOLLECTABLE(Any p0, Any p1) { invoke<Void>(0x4A8CB328CD6F1C9B, p0, p1); }
static void SET_PICKUP_HIDDEN_WHEN_UNCOLLECTABLE(Any p0, Any p1) { invoke<Void>(0x81218CE01B672219, p0, p1); }
static void _0xAC9AE68F0A463752(Any p0) { invoke<Void>(0xAC9AE68F0A463752, p0); }
static void SET_PICKUP_PARTICLE_FX_SPAWN(Any p0, Any p1) { invoke<Void>(0xEB9740A38FD6D634, p0, p1); }
static void SET_PICKUP_PARTICLE_FX_HIGHLIGHT(Any p0, Any p1) { invoke<Void>(0x1607C7D9B3021DF5, p0, p1); }
...
static void _TASK_JUMP_2(Ped ped, float x, float y, float z, Entity entity) { invoke<Void>(0x91083103137D7254, ped, x, y, z, entity); }
static void TASK_COWER(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0x3EB1FE9E8E908E15, p0, p1, p2, p3); }
...
static void TASK_KNOCKED_OUT(Any p0, Any p1, Any p2) { invoke<Void>(0xF90427F00A495A28, p0, p1, p2); }
static void TASK_KNOCKED_OUT_AND_HOGTIED(Any p0, Any p1, Any p2) { invoke<Void>(0x42AC6401ABB8C7E5, p0, p1, p2); }
static void _0xFFB520A3E16F7B7B(Any p0, Any p1) { invoke<Void>(0xFFB520A3E16F7B7B, p0, p1); }
static void _0x8B1FDF63C3193EDA(Any p0, Any p1) { invoke<Void>(0x8B1FDF63C3193EDA, p0, p1); }
...
static void TASK_DUCK(Any p0, Any p1) { invoke<Void>(0xA14B5FBF986BAC23, p0, p1); }
static void _TASK_BOARD_VEHICLE(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5) { invoke<Void>(0xE53D17AD837CBF7C, p0, p1, p2, p3, p4, p5); }
static void _TASK_DISEMBARK_VEHICLE(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5) { invoke<Void>(0xA7C6854BB5A4192A, p0, p1, p2, p3, p4, p5); }
static void _TASK_BOARD_VEHICLE_2(Any p0, Any p1, Any p2, Any p3, Any p4) { invoke<Void>(0xE41A09C8DDFF7AA4, p0, p1, p2, p3, p4); }
static void _TASK_DISEMBARK_VEHICLE_2(Any p0, Any p1, Any p2) { invoke<Void>(0x0A11F3BDEC03ED5F, p0, p1, p2); }
...
static void TASK_LEAVE_VEHICLE(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0xD3DBCE61A490BE02, p0, p1, p2, p3); }
static void TASK_MOUNT_ANIMAL(Ped ped, Ped mount, int timer, int position, float ped_speed, int mount_style, float unk1, float unk2) { invoke<Void>(0x92DB0739813C5186, ped, mount, timer, position, ped_speed, mount_style, unk1, unk2); }
static void TASK_DISMOUNT_ANIMAL(Ped rider, int taskFlag, Any p2, Any p3, Any p4, Any p5) { invoke<Void>(0x48E92D3DDE23C23A, rider, taskFlag, p2, p3, p4, p5); }
static void TASK_HITCH_ANIMAL(Any p0, Any p1, Any p2) { invoke<Void>(0x9030AD4B6207BFE8, p0, p1, p2); }
...
static void _TASK_VEHICLE_DRIVE_TO_COORD_2(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8) { invoke<Void>(0xF0108F01FB105DA2, p0, p1, p2, p3, p4, p5, p6, p7, p8); }
...
static void TASK_FOLLOW_TO_OFFSET_OF_ENTITY(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8, Any p9, Any p10, Any p11, Any p12) { invoke<Void>(0x304AE42E357B8C7E, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12); }
static void TASK_FOLLOW_TO_OFFSET_OF_COORD(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8, Any p9, Any p10, Any p11, Any p12, Any p13, Any p14) { invoke<Void>(0x2E3676282C18A692, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14); }
static void _0x3FFCD7BBA074CC80(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8) { invoke<Void>(0x3FFCD7BBA074CC80, p0, p1, p2, p3, p4, p5, p6, p7, p8); }
static void TASK_GO_STRAIGHT_TO_COORD(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8) { invoke<Void>(0xD76B57B44F1E6F8B, p0, p1, p2, p3, p4, p5, p6, p7, p8); }
static void TASK_GO_STRAIGHT_TO_COORD_RELATIVE_TO_ENTITY(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7) { invoke<Void>(0x61E360B7E040D12E, p0, p1, p2, p3, p4, p5, p6, p7); }
static void _TASK_MOVE_IN_TRAFFIC(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0x8AA1593AEC087A29, p0, p1, p2, p3); }
static void _TASK_MOVE_IN_TRAFFIC_2(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7) { invoke<Void>(0xDCA3A13F7A45338B, p0, p1, p2, p3, p4, p5, p6, p7); }
static void _TASK_MOVE_IN_TRAFFIC_3(Any p0, Any p1, Any p2, Any p3, Any p4) { invoke<Void>(0x13DED0BC45600FE1, p0, p1, p2, p3, p4); }
static void _0xBAAB791AA72C2821(Any p0, Any p1) { invoke<Void>(0xBAAB791AA72C2821, p0, p1); }
static void _TASK_MOVE_IN_TRAFFIC_4(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5) { invoke<Void>(0x79482C12482A860D, p0, p1, p2, p3, p4, p5); }
...
static void TASK_FOLLOW_POINT_ROUTE(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5) { invoke<Void>(0x0E14C5550DC3CD1D, p0, p1, p2, p3, p4, p5); }
static void TASK_ENTER_ANIM_SCENE(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8) { invoke<Void>(0xC2329B0206426644, p0, p1, p2, p3, p4, p5, p6, p7, p8); }
static void TASK_MOVE_BE_IN_FORMATION(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6) { invoke<Void>(0x4AA5AA97C65E4A2F, p0, p1, p2, p3, p4, p5, p6); }
...
static void TASK_FOLLOW_AND_CONVERSE_WITH_PED(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8, Any p9, Any p10) { invoke<Void>(0x489FFCCCE7392B55, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10); }
static void _0xA052608A12559BBB(Any p0, Any p1) { invoke<Void>(0xA052608A12559BBB, p0, p1); }
static void TASK_WANDER_AND_CONVERSE_WITH_PED(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0x8AC76D1408731732, p0, p1, p2, p3); }
static void TASK_LEAD_AND_CONVERSE(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8) { invoke<Void>(0xAA19711D33C6708C, p0, p1, p2, p3, p4, p5, p6, p7, p8); }
static void _0xDE0C8B145EA466FF(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5) { invoke<Void>(0xDE0C8B145EA466FF, p0, p1, p2, p3, p4, p5); }
static void TASK_SEEK_CLEAR_LOS_TO_ENTITY(Any p0, Any p1, Any p2, Any p3, Any p4) { invoke<Void>(0x8D7F2A63688C20A4, p0, p1, p2, p3, p4); }
static void TASK_GO_TO_WHISTLE(Any p0, Any p1, Any p2) { invoke<Void>(0xBAD6545608CECA6E, p0, p1, p2); }
...
static void TASK_LEAD_HORSE(Any p0, Any p1) { invoke<Void>(0x9A7A4A54596FE09D, p0, p1); }
static void _0xED27560703F37258(Any p0) { invoke<Void>(0xED27560703F37258, p0); }
static void _TASK_FLEE_FROM_COORD(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8, Any p9, Any p10, Any p11) { invoke<Void>(0x6879FF208ED87F2A, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11); }
static void _TASK_FLEE_FROM_PED(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8, Any p9) { invoke<Void>(0x7B74D8EEDE9B5727, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9); }
...
static void TASK_SMART_FLEE_PED(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6) { invoke<Void>(0x22B0D0E37CCB840D, p0, p1, p2, p3, p4, p5, p6); }
static void _0x673A8779D229BA5A(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5) { invoke<Void>(0x673A8779D229BA5A, p0, p1, p2, p3, p4, p5); }
static void _0x2E1D6D87346BB7D2(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0x2E1D6D87346BB7D2, p0, p1, p2, p3); }
static void _TASK_SMART_FLEE_STYLE_COORD(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8) { invoke<Void>(0x58428248BF4B64E4, p0, p1, p2, p3, p4, p5, p6, p7, p8); }
static void _TASK_SMART_FLEE_STYLE_PED(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6) { invoke<Void>(0xFD45175A6DFD7CE9, p0, p1, p2, p3, p4, p5, p6); }
static void _TASK_SMART_FLEE_STYLE_COORD_VIA(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8, Any p9, Any p10, Any p11) { invoke<Void>(0x390E0B697D25EAF5, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11); }
static void _TASK_SMART_FLEE_STYLE_PED_VIA(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8, Any p9) { invoke<Void>(0x5802E0F910E4CF1D, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9); }
static void _0xE8F1A5B4CED3725A(Any p0, Any p1, Any p2, Any p3, Any p4) { invoke<Void>(0xE8F1A5B4CED3725A, p0, p1, p2, p3, p4); }
static void _0x3923EC958249657D(Any p0, Any p1, Any p2) { invoke<Void>(0x3923EC958249657D, p0, p1, p2); }
static void _0xA42DC7919159CCCF(Any p0) { invoke<Void>(0xA42DC7919159CCCF, p0); }
static void TASK_FLY_AWAY(Any p0, Any p1) { invoke<Void>(0xE86A537B5A3C297C, p0, p1); }
static void TASK_FLY_TO_COORD(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6) { invoke<Void>(0xD6CFC2D59DA72042, p0, p1, p2, p3, p4, p5, p6); }
static void TASK_FLYING_CIRCLE(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6) { invoke<Void>(0x72997893BFB8ECCC, p0, p1, p2, p3, p4, p5, p6); }
static void TASK_WALK_AWAY(Any p0, Any p1) { invoke<Void>(0x04ACFAC71E6858F9, p0, p1); }
static void TASK_SHOCKING_EVENT_REACT(Any p0, Any p1, Any p2) { invoke<Void>(0x452419CBD838065B, p0, p1, p2); }
static void TASK_REACT(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8) { invoke<Void>(0xC4C32C31920E1B70, p0, p1, p2, p3, p4, p5, p6, p7, p8); }
static void TASK_WANDER_IN_AREA(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7) { invoke<Void>(0xE054346CA3A0F315, p0, p1, p2, p3, p4, p5, p6, p7); }
static void TASK_WANDER_IN_VOLUME(Any p0, Any p1, Any p2, Any p3, Any p4) { invoke<Void>(0x9FDA168777B28424, p0, p1, p2, p3, p4); }
static void TASK_WANDER_STANDARD(Ped ped, float p1, int p2) { invoke<Void>(0xBB9CE077274F6A1B, ped, p1, p2); }
static void TASK_WANDER_SWIM(Any p0, Any p1) { invoke<Void>(0x527EA3DB8BC7F03B, p0, p1); }
...
static void TASK_HORSE_ACTION(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0xA09CFD29100F06C3, p0, p1, p2, p3); }
static void TASK_ANIMAL_INTERACTION(Any p0, Any p1, Any p2, Any p3, Any p4) { invoke<Void>(0xCD181A959CFDD7F4, p0, p1, p2, p3, p4); }
static void TASK_COMBAT_ANIMAL_WARN(Any p0, Any p1, Any p2) { invoke<Void>(0xF960F3D57B660E96, p0, p1, p2); }
static void TASK_COMBAT_ANIMAL_CHARGE(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0xEE3AA414CF99F368, p0, p1, p2, p3); }
static void TASK_AMBIENT_ANIMAL_STALK(Any p0, Any p1, Any p2) { invoke<Void>(0x37C13863ABA1B4A3, p0, p1, p2); }
static void TASK_AMBIENT_ANIMAL_HUNT(Any p0, Any p1, Any p2) { invoke<Void>(0x4B39D8F9D0FE7749, p0, p1, p2); }
static void TASK_ANIMAL_UNALERTED(Any p0, Any p1, Any p2, Any p3, Any p4) { invoke<Void>(0x21FDF9A25CFE1CE5, p0, p1, p2, p3, p4); }
static void TASK_ANIMAL_ALERTED(Any p0, Any p1, Any p2) { invoke<Void>(0x979D93372FC8C565, p0, p1, p2); }
static void TASK_ANIMAL_FLEE(Any p0, Any p1, Any p2) { invoke<Void>(0xA899B61C66F09134, p0, p1, p2); }
static Any _0x244430C13BA5258E(Any p0, Any p1, Any p2, Any p3) { return invoke<Any>(0x244430C13BA5258E, p0, p1, p2, p3); }
static void TASK_EAT(Any p0, Any p1, Any p2) { invoke<Void>(0xBD7949BD07299672, p0, p1, p2); }
static void TASK_BARK(Any p0, Any p1, Any p2) { invoke<Void>(0x83BFC1F836B2F3F2, p0, p1, p2); }
static void TASK_FOLLOW_PAVEMENT_TO_COORD(Any p0, Any p1) { invoke<Void>(0x1B1475414E70DD8E, p0, p1); }
...
static void TASK_FOLLOW_NAV_MESH_TO_COORD_ADVANCED(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8, Any p9, Any p10, Any p11, Any p12) { invoke<Void>(0x17F58B88D085DBAC, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12); }
...
static void _0x1632EB9386CDBE64(Any p0, Any p1) { invoke<Void>(0x1632EB9386CDBE64, p0, p1); }
static void _0x88E32DB8C1A4AA4B(Ped ped, float p1) { invoke<Void>(0x88E32DB8C1A4AA4B, ped, p1); }
static void _0xE8C296B75EACC357(Any p0, Any p1) { invoke<Void>(0xE8C296B75EACC357, p0, p1); }
static void _0x3AD8EFF9703BE657(Any p0, Any p1) { invoke<Void>(0x3AD8EFF9703BE657, p0, p1); }
static void _0x8798CF6815B8FE0F(Any p0, Any p1) { invoke<Void>(0x8798CF6815B8FE0F, p0, p1); }
static void _0x5B68D0007D9C92EB(Any p0, Any p1) { invoke<Void>(0x5B68D0007D9C92EB, p0, p1); }
static void _0x82ED59F095056550(Any p0, Any p1) { invoke<Void>(0x82ED59F095056550, p0, p1); }
static void _0xE01C8DC8EDD28D31(Any p0, Any p1) { invoke<Void>(0xE01C8DC8EDD28D31, p0, p1); }
static void _0x098CAA6DBE7D8D82(Any p0, Any p1) { invoke<Void>(0x098CAA6DBE7D8D82, p0, p1); }
static Any _0x1948BBE561A2375A(Any p0) { return invoke<Any>(0x1948BBE561A2375A, p0); }
static void _0x013A7BA5015C1372(Any p0, Any p1) { invoke<Void>(0x013A7BA5015C1372, p0, p1); }
static void SET_PED_PATH_MAY_ENTER_WATER(Ped ped, BOOL mayEnterWater) { invoke<Void>(0xF35425A4204367EC, ped, mayEnterWater); }
static void _0x9DE63896B176EA94(Any p0, Any p1) { invoke<Void>(0x9DE63896B176EA94, p0, p1); }
static void _0xC6170856E54557B2(Any p0, Any p1, Any p2) { invoke<Void>(0xC6170856E54557B2, p0, p1, p2); }
static void _0xF948F4356F010F11(Any p0, Any p1, Any p2) { invoke<Void>(0xF948F4356F010F11, p0, p1, p2); }
static void SET_PED_PATH_PREFER_TO_AVOID_WATER(Any p0, Any p1, Any p2) { invoke<Void>(0x38FE1EC73743793C, p0, p1, p2); }
static void _0x8BB283A7888AD1AD(Any p0, Any p1, Any p2) { invoke<Void>(0x8BB283A7888AD1AD, p0, p1, p2); }
static void _0x12990818C1D35886(Any p0, Any p1, Any p2) { invoke<Void>(0x12990818C1D35886, p0, p1, p2); }
static void _0x7C015D8BCEC72CF4(Any p0, Any p1) { invoke<Void>(0x7C015D8BCEC72CF4, p0, p1); }
static void SET_PED_PATH_AVOID_FIRE(Ped ped, BOOL avoidFire) { invoke<Void>(0x4455517B28441E60, ped, avoidFire); }
static void _0x42CFD8FD8CC8DC69(Any p0, Any p1) { invoke<Void>(0x42CFD8FD8CC8DC69, p0, p1); }
static void _0x216343750545A486(Any p0, Any p1, Any p2) { invoke<Void>(0x216343750545A486, p0, p1, p2); }
static void _0xFA30E2254461ADEB(Any p0, Any p1) { invoke<Void>(0xFA30E2254461ADEB, p0, p1); }
...
static void TASK_GO_TO_COORD_ANY_MEANS_EXTRA_PARAMS(Ped ped, float x, float y, float z, float speed, Any p5, BOOL p6, int walkingStyle, float p8, Any p9, Any p10, Any p11, Any p12) { invoke<Void>(0x1DD45F9ECFDB1BC9, ped, x, y, z, speed, p5, p6, walkingStyle, p8, p9, p10, p11, p12); }
static void TASK_GO_TO_COORD_ANY_MEANS_EXTRA_PARAMS_WITH_CRUISE_SPEED(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8, Any p9, Any p10, Any p11, Any p12, Any p13, Any p14) { invoke<Void>(0xB8ECD61F531A7B02, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14); }
static void TASK_PLAY_ANIM(Ped ped, const char* animDict, const char* animName, float speed, float speedMultiplier, int duration, int flags, float playbackRate, BOOL p8, Any p9, BOOL p10, const char* p11, BOOL p12) { invoke<Void>(0xEA47FE3719165B94, ped, animDict, animName, speed, speedMultiplier, duration, flags, playbackRate, p8, p9, p10, p11, p12); }
static void TASK_PLAY_ANIM_ADVANCED(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8, Any p9, Any p10, Any p11, Any p12, Any p13, Any p14, Any p15, Any p16) { invoke<Void>(0x83CDB10EA29B370B, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15, p16); }
static void TASK_PLAY_UPPER_ANIM_FACING_ENTITY(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8, Any p9, Any p10, Any p11, Any p12, Any p13, Any p14) { invoke<Void>(0xAD67214236AB1CFE, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14); }
static void STOP_ANIM_TASK(Ped ped, const char* animDictionary, const char* animationName, float p3) { invoke<Void>(0x97FF36A1D40EA00A, ped, animDictionary, animationName, p3); }
static void TASK_SCRIPTED_ANIMATION(Any p0, Any p1) { invoke<Void>(0x126EF75F1E17ABE5, p0, p1); }
...
static void _0x87B66D77D545DB66(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0x87B66D77D545DB66, p0, p1, p2, p3); }
static void SET_ANIM_RATE(Any p0, float p1, Any p2, BOOL p3) { invoke<Void>(0x032D49C5E359C847, p0, p1, p2, p3); }
static Any _0x2D19BC4DF626CBE7(Any p0, Any p1, Any p2, Any p3) { return invoke<Any>(0x2D19BC4DF626CBE7, p0, p1, p2, p3); }
static void _TASK_ITEM_INTERACTION(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5) { invoke<Void>(0xAE72E7DF013AAA61, p0, p1, p2, p3, p4, p5); }
static void _TASK_ITEM_INTERACTION_2(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7) { invoke<Void>(0x72F52AA2D2B172CC, p0, p1, p2, p3, p4, p5, p6, p7); }
static void _TASK_ITEM_INTERACTION_3(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6) { invoke<Void>(0xD61D5E1AD9876DEB, p0, p1, p2, p3, p4, p5, p6); }
static void _0xB35370D5353995CB(Any p0, Any p1, Any p2) { invoke<Void>(0xB35370D5353995CB, p0, p1, p2); }
...
static Any _0x038B1F1674F0E242(Any p0) { return invoke<Any>(0x038B1F1674F0E242, p0); }
static Any _0xEC7E480FF8BD0BED(Any p0) { return invoke<Any>(0xEC7E480FF8BD0BED, p0); }
static Any _0x05A0100EA714DB68(Any p0, Any p1) { return invoke<Any>(0x05A0100EA714DB68, p0, p1); }
static Any _0xBC864A70AD55E0C1(Any p0, Any p1) { return invoke<Any>(0xBC864A70AD55E0C1, p0, p1); }
static Any _0x678D3226CF70B9C8(Any p0, Any p1) { return invoke<Any>(0x678D3226CF70B9C8, p0, p1); }
static void TASK_EVASIVE_ANIM(Any p0, Any p1, Any p2) { invoke<Void>(0x5F22926E1BCE9B08, p0, p1, p2); }
static void TASK_LOOK_AT_COORD(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7) { invoke<Void>(0x6FA46612594F7973, p0, p1, p2, p3, p4, p5, p6, p7); }
static void TASK_LOOK_AT_ENTITY(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5) { invoke<Void>(0x69F4BE8C8CC4796C, p0, p1, p2, p3, p4, p5); }
static void TASK_CLEAR_LOOK_AT(Ped ped) { invoke<Void>(0x0F804F1DB19B9689, ped); }
static Any _0x508F5053E3F6F0C4(Any p0, Any p1, Any p2, Any p3, Any p4) { return invoke<Any>(0x508F5053E3F6F0C4, p0, p1, p2, p3, p4); }
...
static void _TASK_PERFORM_SEQUENCE_2(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0x4FC0AF869D6E309D, p0, p1, p2, p3); }
...
static int GET_SCRIPT_TASK_STATUS(Any p0, Any p1, Any p2) { return invoke<int>(0x77F1BEB8863288D5, p0, p1, p2); }
static Any _0x9FF5F9B24E870748(Any p0) { return invoke<Any>(0x9FF5F9B24E870748, p0); }
static Any _0xA710DC5D25F8B942(Any p0, Any p1) { return invoke<Any>(0xA710DC5D25F8B942, p0, p1); }
static void _0xE7FA07624574B79A(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8) { invoke<Void>(0xE7FA07624574B79A, p0, p1, p2, p3, p4, p5, p6, p7, p8); }
static void _0x541E5B41DCA45828(Any p0, Any p1, Any p2) { invoke<Void>(0x541E5B41DCA45828, p0, p1, p2); }
static Any _0x916B8E075ABC8B4E(Any p0, Any p1) { return invoke<Any>(0x916B8E075ABC8B4E, p0, p1); }
...
static void TASK_USE_RANDOM_SCENARIO_IN_GROUP(Any p0, Any p1, Any p2, Any p3, Any p4) { invoke<Void>(0x14747F4A5971DE4E, p0, p1, p2, p3, p4); }
static void TASK_AIM_GUN_AT_ENTITY(Any p0, Any p1, Any p2, Any p3, Any p4) { invoke<Void>(0x9B53BB6E8943AF53, p0, p1, p2, p3, p4); }
static void TASK_TURN_PED_TO_FACE_ENTITY(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5) { invoke<Void>(0x5AD23D40115353AC, p0, p1, p2, p3, p4, p5); }
...
static void TASK_AIM_AT_COORD(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6) { invoke<Void>(0x4AF1D73861212F52, p0, p1, p2, p3, p4, p5, p6); }
static void TASK_AIM_AT_ENTITY(Any p0, Any p1, Any p2, Any p3, Any p4) { invoke<Void>(0xCF7569BD0FB480A0, p0, p1, p2, p3, p4); }
static void TASK_SHOOT_AT_COORD(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6) { invoke<Void>(0x46A6CC01E0826106, p0, p1, p2, p3, p4, p5, p6); }
static void TASK_SHUFFLE_TO_NEXT_VEHICLE_SEAT(Any p0, Any p1) { invoke<Void>(0x7AA80209BDA643EB, p0, p1); }
static void CLEAR_PED_TASKS(Any p0, Any p1, Any p2) { invoke<Void>(0xE1EF3C1216AFF2CD, p0, p1, p2); }
...
static void TASK_EVERYONE_LEAVE_VEHICLE(Any p0, Any p1) { invoke<Void>(0x7F93691AB4B92272, p0, p1); }
static void TASK_EVERYONE_LEAVE_VEHICLE_IN_ORDER(Any p0, Any p1) { invoke<Void>(0x6F1C49F275BD25B3, p0, p1); }
static void TASK_INVESTIGATE(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5) { invoke<Void>(0x5C8514540D27FBFB, p0, p1, p2, p3, p4, p5); }
...
static void TASK_GOTO_ENTITY_OFFSET_XY(int p0, Ped oed, int duration, float p3, float p4, float p5, float p6, BOOL p7) { invoke<Void>(0x338E7EF52B6095A9, p0, oed, duration, p3, p4, p5, p6, p7); }
static void TASK_GOTO_ENTITY_OFFSET_XY_AIMING(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8) { invoke<Void>(0x901BD69984400F62, p0, p1, p2, p3, p4, p5, p6, p7, p8); }
static void TASK_GOTO_ENTITY_OFFSET_XYZ_AIMING(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8, Any p9) { invoke<Void>(0x41B0832CA96B5351, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9); }
static void TASK_FOLLOW_ENTITY_WHILE_AIMING_AT_ENTITY(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7) { invoke<Void>(0x2D532EAA142CF83F, p0, p1, p2, p3, p4, p5, p6, p7); }
...
static void _TASK_VEHICLE_DRIVE_TO_DESTINATION(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8, Any p9, Any p10) { invoke<Void>(0x7F241A0D14354583, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10); }
static void _TASK_VEHICLE_DRIVE_TO_DESTINATION_2(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8) { invoke<Void>(0x391073B9D3CCE2BA, p0, p1, p2, p3, p4, p5, p6, p7, p8); }
static void _0x55CD5FDDD4335C1E(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5) { invoke<Void>(0x55CD5FDDD4335C1E, p0, p1, p2, p3, p4, p5); }
static void _TASK_VEHICLE_DRIVE_TO_POINT(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7) { invoke<Void>(0x089FF2FB965F0A29, p0, p1, p2, p3, p4, p5, p6, p7); }
static void _TASK_VEHICLE_DRIVE_TO_POINT_2(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6) { invoke<Void>(0x6524A8981E8BE7C9, p0, p1, p2, p3, p4, p5, p6); }
static void _0x1D125814EBC517EB(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0x1D125814EBC517EB, p0, p1, p2, p3); }
static Any _0x583AE9AF9CEE0958(Any p0, Any p1, Any p2, Any p3) { return invoke<Any>(0x583AE9AF9CEE0958, p0, p1, p2, p3); }
...
static void _0xA263ADBBC8056214(Any p0, Any p1) { invoke<Void>(0xA263ADBBC8056214, p0, p1); }
...
static void TASK_WEAPON(Ped ped) { invoke<Void>(0x7157B82D60E4BC46, ped); }
...
static Any _0x8785E6E40C7A8819(Any p0) { return invoke<Any>(0x8785E6E40C7A8819, p0); }
static void _0x34C0010188D7C54A(Any p0, Any p1) { invoke<Void>(0x34C0010188D7C54A, p0, p1); }
...
static void TASK_SHOOT_AT_ENTITY(Any p0, Any p1, Any p2, Any p3, Any p4) { invoke<Void>(0x08DA95E8298AE772, p0, p1, p2, p3, p4); }
static void TASK_SHOOT_WITH_WEAPON(Any p0, Any p1) { invoke<Void>(0x08AA95E8298AE772, p0, p1); }
static void _0x2416EC2F31F75266(Any p0, Any p1, Any p2, Any p3, Any p4) { invoke<Void>(0x2416EC2F31F75266, p0, p1, p2, p3, p4); }
static void _0x41323F4E0C4AE94B(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6) { invoke<Void>(0x41323F4E0C4AE94B, p0, p1, p2, p3, p4, p5, p6); }
...
static void _0xDF1D85BCAF60D537(Any p0, Any p1) { invoke<Void>(0xDF1D85BCAF60D537, p0, p1); }
static void TASK_CLIMB_LADDER(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0xB6C987F9285A3814, p0, p1, p2, p3); }
static void CLEAR_PED_TASKS_IMMEDIATELY(Ped p0, BOOL p1, BOOL p2) { invoke<Void>(0xAAA34F8A7CB32098, p0, p1, p2); }
static void TASK_PERFORM_SEQUENCE_FROM_PROGRESS(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0x89221B16730234F0, p0, p1, p2, p3); }
...
static void TASK_PED_SLIDE_TO_COORD(Ped ped, float x, float y, float z, float heading, float p5) { invoke<Void>(0xD04FE6765D990A06, ped, x, y, z, heading, p5); }
...
static ScrHandle ADD_COVER_POINT(float p0, float p1, float p2, float p3, Any p4, Any p5, Any p6, BOOL p7) { return invoke<ScrHandle>(0xD5C12A75C7B9497F, p0, p1, p2, p3, p4, p5, p6, p7); }
...
static BOOL DOES_SCRIPTED_COVER_POINT_EXIST_AT_COORDS(Any p0, Any p1, Any p2, Any p3) { return invoke<BOOL>(0xA98B8E3C088E5A31, p0, p1, p2, p3); }
...
static void TASK_COMBAT_PED_TIMED(Any p0, Ped ped, int p2, Any p3) { invoke<Void>(0x944F30DCB7096BDE, p0, ped, p2, p3); }
static void _TASK_COMBAT_PED_3(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5) { invoke<Void>(0xC624414FA748B9BA, p0, p1, p2, p3, p4, p5); }
static void TASK_SEEK_COVER_FROM_POS(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7) { invoke<Void>(0x75AC2B60386D89F2, p0, p1, p2, p3, p4, p5, p6, p7); }
static void TASK_SEEK_COVER_FROM_PED(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5) { invoke<Void>(0x84D32B3BEC531324, p0, p1, p2, p3, p4, p5); }
static void TASK_SEEK_COVER_TO_COVER_POINT(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8) { invoke<Void>(0xD43D95C7A869447F, p0, p1, p2, p3, p4, p5, p6, p7, p8); }
static void TASK_SEEK_COVER_TO_COORDS(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8, Any p9, Any p10) { invoke<Void>(0x39246A6958EF072C, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10); }
static void TASK_PUT_PED_DIRECTLY_INTO_COVER(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8, Any p9, Any p10, Any p11, Any p12) { invoke<Void>(0x4172393E6BE1FECE, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12); }
static void _0xDF8A5855B9F9A97B(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8, Any p9, Any p10, Any p11, Any p12, Any p13, Any p14, Any p15, Any p16, Any p17) { invoke<Void>(0xDF8A5855B9F9A97B, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15, p16, p17); }
static void TASK_PUT_PED_DIRECTLY_INTO_MELEE(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6) { invoke<Void>(0x1C6CD14A876FFE39, p0, p1, p2, p3, p4, p5, p6); }
static void _0xA05F3F20889D7A5B(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6) { invoke<Void>(0xA05F3F20889D7A5B, p0, p1, p2, p3, p4, p5, p6); }
static void TASK_COMPANION_AMBIENT(Any p0, Any p1) { invoke<Void>(0xE017CF6E2527FE4F, p0, p1); }
static void _0x098036CAB8373D36(Any p0) { invoke<Void>(0x098036CAB8373D36, p0); }
static void _0x10C44F633E2D6D9E(Any p0) { invoke<Void>(0x10C44F633E2D6D9E, p0); }
static void _0x7FB78B2199C10E92(Any p0) { invoke<Void>(0x7FB78B2199C10E92, p0); }
static void TASK_GUARD(Any p0, Any p1, Any p2) { invoke<Void>(0xB9FB242EACCAF30F, p0, p1, p2); }
static void TASK_GUARD_CURRENT_POSITION(Ped p0, float p1, float p2, BOOL p3) { invoke<Void>(0x4A58A47A72E3FCB4, p0, p1, p2, p3); }
static void _TASK_GUARD_ASSIGNED_DEFENSIVE_AREA_2(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7) { invoke<Void>(0x1FC9B33976BACD6C, p0, p1, p2, p3, p4, p5, p6, p7); }
...
static void _0xEB2ED1DC3AEC0654(Any p0, Any p1, Any p2, Any p3, Any p4) { invoke<Void>(0xEB2ED1DC3AEC0654, p0, p1, p2, p3, p4); }
...
static void TASK_ROB_PED(Any p0, Any p1, Any p2, Any p3, Any p4) { invoke<Void>(0x7BB967F85D8CCBDB, p0, p1, p2, p3, p4); }
static Any _0xBEDBE39B5FD98FD6(Any p0) { return invoke<Any>(0xBEDBE39B5FD98FD6, p0); }
static Any _0x94B745CE41DB58A1(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7) { return invoke<Any>(0x94B745CE41DB58A1, p0, p1, p2, p3, p4, p5, p6, p7); }
static Any _0x794AB1379A74064D(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8) { return invoke<Any>(0x794AB1379A74064D, p0, p1, p2, p3, p4, p5, p6, p7, p8); }
static Any _0xEA31F199A73801D3(Any p0) { return invoke<Any>(0xEA31F199A73801D3, p0); }
static Any _0x295514F198EFD0CA(Any p0, Any p1) { return invoke<Any>(0x295514F198EFD0CA, p0, p1); }
static Any _0x8360C47380B6F351(Any p0, Any p1, Any p2, Any p3) { return invoke<Any>(0x8360C47380B6F351, p0, p1, p2, p3); }
static void _0x5AF19B6CC2115D34(Any p0, Any p1, Any p2) { invoke<Void>(0x5AF19B6CC2115D34, p0, p1, p2); }
static Any _0x8569C38D2FB80650(Any p0, Any p1) { return invoke<Any>(0x8569C38D2FB80650, p0, p1); }
static void _0xADC45010BC17AF0E(Any p0, Any p1) { invoke<Void>(0xADC45010BC17AF0E, p0, p1); }
static Any _0x974DA3408DEC4E79(Any p0) { return invoke<Any>(0x974DA3408DEC4E79, p0); }
static Any _0x6EF4E31B4D5D2DA0(Any p0, Any p1) { return invoke<Any>(0x6EF4E31B4D5D2DA0, p0, p1); }
static Any _0x841475AC96E794D1(Any p0) { return invoke<Any>(0x841475AC96E794D1, p0); }
...
static Vector3 _0xA8452DD321607029(Any p0, Any p1) { return invoke<Vector3>(0xA8452DD321607029, p0, p1); }
...
static Any _0xB93EA7184BAA85C3(Any p0, Any p1) { return invoke<Any>(0xB93EA7184BAA85C3, p0, p1); }
static Any _0x6718F40313A2B5A6(Any p0) { return invoke<Any>(0x6718F40313A2B5A6, p0); }
static void _0x2056AB38DF06825C(Any p0, Any p1, Any p2, Any p3, Any p4) { invoke<Void>(0x2056AB38DF06825C, p0, p1, p2, p3, p4); }
static void _0xD3A0DA8F91612C6E(Any p0, Any p1, Any p2) { invoke<Void>(0xD3A0DA8F91612C6E, p0, p1, p2); }
static void _0xC47D9080A9A8856A(Any p0, Any p1) { invoke<Void>(0xC47D9080A9A8856A, p0, p1); }
static void _0xA7479FB665361EDB(Any p0, Any p1) { invoke<Void>(0xA7479FB665361EDB, p0, p1); }
static void _0xE69FDA40AAC3EFC0(Any p0, Any p1) { invoke<Void>(0xE69FDA40AAC3EFC0, p0, p1); }
static Any _0x345EC3B7EBDE1CB5(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5) { return invoke<Any>(0x345EC3B7EBDE1CB5, p0, p1, p2, p3, p4, p5); }
...
static Any _0xDF7993356F52359A(Any p0, Any p1) { return invoke<Any>(0xDF7993356F52359A, p0, p1); }
static Any _0xD04241BBF6D03A5E(Any p0) { return invoke<Any>(0xD04241BBF6D03A5E, p0); }
static void _0x188F8071F244B9B8(Any p0, Any p1) { invoke<Void>(0x188F8071F244B9B8, p0, p1); }
...
static Any _0xB219612B5568E9EC(Any p0) { return invoke<Any>(0xB219612B5568E9EC, p0); }
...
static void _TASK_USE_SCENARIO_POINT(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8, Any p9) { invoke<Void>(0xCCDAE6324B6A821C, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9); }
static void _TASK_USE_SCENARIO_POINT_2(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7) { invoke<Void>(0x0F6641449DD86FBE, p0, p1, p2, p3, p4, p5, p6, p7); }
static void _TASK_START_SCENARIO_IN_PLACE(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6) { invoke<Void>(0x524B54361229154F, p0, p1, p2, p3, p4, p5, p6); }
static void _TASK_START_SCENARIO_IN_PLACE_2(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6) { invoke<Void>(0xA917E39F2CEFD215, p0, p1, p2, p3, p4, p5, p6); }
static void TASK_START_SCENARIO_AT_POSITION(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8, Any p9, Any p10, Any p11) { invoke<Void>(0x4D1F61FC34AF3CD1, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11); }
...
static Any _0x00FFE0F85253C572(Any p0) { return invoke<Any>(0x00FFE0F85253C572, p0); }
static void _TASK_USE_NEAREST_SCENARIO_TO_COORD(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8, Any p9) { invoke<Void>(0x322BFDEA666E2B0E, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9); }
static void TASK_USE_NEAREST_SCENARIO_TO_COORD_WARP(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8, Any p9) { invoke<Void>(0x58E2E0F23F6B76C3, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9); }
static void TASK_USE_NEAREST_TRAIN_SCENARIO_TO_COORD_WARP(Any p0, Any p1, Any p2, Any p3, Any p4) { invoke<Void>(0x3774B03456DD6106, p0, p1, p2, p3, p4); }
static void TASK_USE_NEAREST_SCENARIO_CHAIN_TO_COORD(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8) { invoke<Void>(0x9FDA1B3D7E7028B3, p0, p1, p2, p3, p4, p5, p6, p7, p8); }
static void TASK_USE_NEAREST_SCENARIO_CHAIN_TO_COORD_WARP(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8) { invoke<Void>(0x97A28E63F0BA5631, p0, p1, p2, p3, p4, p5, p6, p7, p8); }
static Any _0xFDECCA06E8B81346(Any p0) { return invoke<Any>(0xFDECCA06E8B81346, p0); }
static Any _0x2D657B10F211C572(Any p0, Any p1) { return invoke<Any>(0x2D657B10F211C572, p0, p1); }
static void TASK_RIDE_TRAIN(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0x37FB1C870E2EC2C6, p0, p1, p2, p3); }
...
static BOOL DOES_SCENARIO_EXIST_IN_AREA(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6) { return invoke<BOOL>(0x5A59271FFADD33C1, p0, p1, p2, p3, p4, p5, p6); }
static Any _0x6EEAD6AF637DA752(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5) { return invoke<Any>(0x6EEAD6AF637DA752, p0, p1, p2, p3, p4, p5); }
static Any _0xF533D68FF970D190(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6) { return invoke<Any>(0xF533D68FF970D190, p0, p1, p2, p3, p4, p5, p6); }
...
static void _0xB8E213D02F37947D(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6) { invoke<Void>(0xB8E213D02F37947D, p0, p1, p2, p3, p4, p5, p6); }
...
static Any _0x02EBBB3989B7E695(Any p0) { return invoke<Any>(0x02EBBB3989B7E695, p0); }
...
static void _0x19BC99C678FBA139(Any p0, Any p1, Any p2) { invoke<Void>(0x19BC99C678FBA139, p0, p1, p2); }
static void _0x5D9B0BAAF04CF65B(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0x5D9B0BAAF04CF65B, p0, p1, p2, p3); }
static void _0x9B6A58FDB0024F12(Any p0, Any p1) { invoke<Void>(0x9B6A58FDB0024F12, p0, p1); }
static void _0xBC3F847AE2C3DC65(Any p0, Any p1) { invoke<Void>(0xBC3F847AE2C3DC65, p0, p1); }
static void _0x450080DDEDB91258(Any p0, Any p1) { invoke<Void>(0x450080DDEDB91258, p0, p1); }
static void _0x954451EA2D2120FB(Any p0, Any p1) { invoke<Void>(0x954451EA2D2120FB, p0, p1); }
static void _0x0F4F6C4CE471259D(Any p0, Any p1) { invoke<Void>(0x0F4F6C4CE471259D, p0, p1); }
static void _0xB8E3486D107F4194(Any p0, Any p1) { invoke<Void>(0xB8E3486D107F4194, p0, p1); }
static void _0x827A58CED9D4D5B4(Any p0, Any p1) { invoke<Void>(0x827A58CED9D4D5B4, p0, p1); }
static void _0x4A7D73989F52EB37(Any p0, Any p1) { invoke<Void>(0x4A7D73989F52EB37, p0, p1); }
static void _0xB79817DB31FF72B9(Any p0, Any p1) { invoke<Void>(0xB79817DB31FF72B9, p0, p1); }
static void _0x65D281985F2BDFC2(Any p0, Any p1) { invoke<Void>(0x65D281985F2BDFC2, p0, p1); }
static void _0x885D19AC2B6FBFF4(Any p0, Any p1) { invoke<Void>(0x885D19AC2B6FBFF4, p0, p1); }
static void _0x2064B33F6E6B92D4(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0x2064B33F6E6B92D4, p0, p1, p2, p3); }
static void _0xCE4E669400E5F8AA(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0xCE4E669400E5F8AA, p0, p1, p2, p3); }
static void _0x2EB977293923C723(Any p0, Any p1) { invoke<Void>(0x2EB977293923C723, p0, p1); }
static void _0xE9225354FB7437A7(Any p0, Any p1) { invoke<Void>(0xE9225354FB7437A7, p0, p1); }
static void _0x764DB5A48390FBAD(Any p0, Any p1) { invoke<Void>(0x764DB5A48390FBAD, p0, p1); }
static void _0x8F8C84363810691A(Any p0, Any p1) { invoke<Void>(0x8F8C84363810691A, p0, p1); }
...
static Any _0x76E98B52369A289C(Any p0) { return invoke<Any>(0x76E98B52369A289C, p0); }
static BOOL IS_SCENARIO_GROUP_ENABLED(const char* scenarioGroup) { return invoke<BOOL>(0x367A09DED4E05B99, scenarioGroup); }
static Any _0xDCC374913DE6AAA6(Any p0) { return invoke<Any>(0xDCC374913DE6AAA6, p0); }
static void SET_SCENARIO_GROUP_ENABLED(const char* scenarioGroup, BOOL p1) { invoke<Void>(0x02C8E5B49848664E, scenarioGroup, p1); }
static void _0x9925EDDB6EAB88CD(Any p0, Any p1) { invoke<Void>(0x9925EDDB6EAB88CD, p0, p1); }
...
static void _0x444C910A5058E568(Any p0, Any p1) { invoke<Void>(0x444C910A5058E568, p0, p1); }
...
static void _0xEEE4829304F93EEE(Any p0, Any p1) { invoke<Void>(0xEEE4829304F93EEE, p0, p1); }
...
static void _0xD00E50E673802D71(Any p0, Any p1) { invoke<Void>(0xD00E50E673802D71, p0, p1); }
...
static BOOL IS_PED_ACTIVE_IN_SCENARIO(Any p0, Any p1) { return invoke<BOOL>(0xAA135F9482C82CC3, p0, p1); }
static Any _0x0C3CB2E600C8977D(Any p0, Any p1) { return invoke<Any>(0x0C3CB2E600C8977D, p0, p1); }
static Any _0x2C497BDEF897C6DF(Any p0) { return invoke<Any>(0x2C497BDEF897C6DF, p0); }
static void TASK_COMBAT_HATED_TARGETS_IN_AREA(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6) { invoke<Void>(0x4CF5F55DAC3280A0, p0, p1, p2, p3, p4, p5, p6); }
static void TASK_COMBAT_HATED_TARGETS_NO_LOS_TEST(Any p0, Any p1) { invoke<Void>(0xB5BC69D9C4060BC3, p0, p1); }
static void TASK_COMBAT_HATED_TARGETS_AROUND_PED(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0x7BF835BB9E2698C8, p0, p1, p2, p3); }
static void TASK_COMBAT_HATED_TARGETS_AROUND_PED_TIMED(Any p0, float p1, Any p2, Any p3) { invoke<Void>(0x2BBA30B854534A0C, p0, p1, p2, p3); }
static void TASK_COMBAT_HATED_TARGETS(Any p0, Any p1) { invoke<Void>(0x8182B561A29BD597, p0, p1); }
static void _0x30B391915538EBE2(Any p0) { invoke<Void>(0x30B391915538EBE2, p0); }
static void TASK_THROW_PROJECTILE(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0x7285951DBF6B5A51, p0, p1, p2, p3); }
static void _TASK_THROW_PROJECTILE_2(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0x7282356DFF6B5A51, p0, p1, p2, p3); }
static void TASK_WHISTLE_ANIM(Any p0, Any p1, Any p2) { invoke<Void>(0xD6401A1B2F63BED6, p0, p1, p2); }
static void TASK_SWAP_WEAPON(Any p0, Any p1, Any p2, Any p3, Any p4) { invoke<Void>(0xA21C51255B205245, p0, p1, p2, p3, p4); }
static void _0x0000A8ACDC2E1B6A(Any p0, Any p1) { invoke<Void>(0x0000A8ACDC2E1B6A, p0, p1); }
static void TASK_RELOAD_WEAPON(Ped ped, BOOL unused) { invoke<Void>(0x62D2916F56B9CD2D, ped, unused); }
static void TASK_PICK_UP_WEAPON(Any p0, Any p1) { invoke<Void>(0x55B0ECFD98596624, p0, p1); }
static BOOL IS_PED_GETTING_UP(Ped ped) { return invoke<BOOL>(0x2A74E1D5F2F00EEC, ped); }
static void TASK_ANIMAL_WRITHE(Any p0, Any p1, Any p2) { invoke<Void>(0x8C038A39C4A4B6D6, p0, p1, p2); }
static void _0x30A768C30D385EC5(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5) { invoke<Void>(0x30A768C30D385EC5, p0, p1, p2, p3, p4, p5); }
...
static void TASK_REVIVE_TARGET(Any p0, Any p1, Any p2) { invoke<Void>(0x356088527D9EBAAD, p0, p1, p2); }
...
static void ADD_PATROL_ROUTE_NODE(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8, Any p9) { invoke<Void>(0x8EDF950167586B7C, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9); }
...
static void TASK_PATROL(Ped ped, const char* p1, Any p2, BOOL p3, BOOL p4) { invoke<Void>(0xBDA5DF49D080FE4E, ped, p1, p2, p3, p4); }
static void _TASK_PATROL_2(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7) { invoke<Void>(0x964B06C88E4C86DB, p0, p1, p2, p3, p4, p5, p6, p7); }
static void TASK_STAY_IN_COVER(Ped ped) { invoke<Void>(0xE5DA8615A6180789, ped); }
static void TASK_VEHICLE_SHOOT_AT_PED(Ped ped, Ped target, float p2) { invoke<Void>(0x10AB107B887214D8, ped, target, p2); }
...
static void _0xAF2EF28CE3084505(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0xAF2EF28CE3084505, p0, p1, p2, p3); }
...
static void TASK_GO_TO_COORD_WHILE_AIMING_AT_COORD(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8, Any p9, Any p10, Any p11, Any p12, Any p13, Any p14, Any p15) { invoke<Void>(0x11315AB3385B8AC0, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15); }
static void TASK_GO_TO_COORD_WHILE_AIMING_AT_COORD_USING_COMBAT_STYLE(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8, Any p9, Any p10, Any p11, Any p12, Any p13, Any p14, Any p15) { invoke<Void>(0x639C0425A0B4E77E, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15); }
static void TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8, Any p9, Any p10, Any p11, Any p12, Any p13, Any p14) { invoke<Void>(0xB2A16444EAD9AE47, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14); }
static void TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY_USING_COMBAT_STYLE(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8, Any p9, Any p10, Any p11, Any p12, Any p13, Any p14) { invoke<Void>(0x78426D0982D083C9, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14); }
static void TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8, Any p9, Any p10) { invoke<Void>(0x97465886D35210E9, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10); }
static void TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY_USING_COMBAT_STYLE(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8, Any p9, Any p10) { invoke<Void>(0xCEF0117C233026AD, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10); }
...
static void TASK_GO_TO_COORD_AND_AIM_AT_HATED_ENTITIES_NEAR_COORD_USING_COMBAT_STYLE(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8, Any p9, Any p10, Any p11, Any p12, Any p13, Any p14) { invoke<Void>(0x87BD711FC31EA273, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14); }
static void SET_HIGH_FALL_TASK(Ped ped, Any p1, Any p2, Any p3) { invoke<Void>(0x8C825BDC7741D37C, ped, p1, p2, p3); }
static void _0x5217B7B6DB78E1F3(Any p0, Any p1, Any p2, Any p3, Any p4) { invoke<Void>(0x5217B7B6DB78E1F3, p0, p1, p2, p3, p4); }
...
static void TASK_FOLLOW_WAYPOINT_RECORDING_ADVANCED(Any p0, Any p1) { invoke<Void>(0x0CFC13EBC19BCA52, p0, p1); }
static void TASK_FOLLOW_WAYPOINT_RECORDING(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7) { invoke<Void>(0x0759591819534F7B, p0, p1, p2, p3, p4, p5, p6, p7); }
static void TASK_FOLLOW_WAYPOINT_RECORDING_AT_OFFSET(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6) { invoke<Void>(0xBE9B0520BD7C445B, p0, p1, p2, p3, p4, p5, p6); }
static void TASK_FOLLOW_ENTITY_ALONG_WAYPOINT_RECORDING_AT_OFFSET(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8) { invoke<Void>(0x4D2B787BAE9AB760, p0, p1, p2, p3, p4, p5, p6, p7, p8); }
...
static Any SET_PED_WAYPOINT_ROUTE_OFFSET(Any p0, Any p1, Any p2, Any p3) { return invoke<Any>(0xED98E10B0AFCE4B4, p0, p1, p2, p3); }
static float GET_WAYPOINT_DISTANCE_ALONG_ROUTE(const char* p0, int p1) { return invoke<float>(0xA5B769058763E497, p0, p1); }
static Any _0x3ACC128510142B9D(Any p0, Any p1, Any p2, Any p3) { return invoke<Any>(0x3ACC128510142B9D, p0, p1, p2, p3); }
static BOOL WAYPOINT_PLAYBACK_GET_IS_PAUSED(Any p0) { return invoke<BOOL>(0x701375A7D43F01CB, p0); }
static Any WAYPOINT_PLAYBACK_GET_IS_AIMING(Any p0) { return invoke<Any>(0xD73A5D1F0325C71C, p0); }
static Any WAYPOINT_PLAYBACK_GET_IS_SHOOTING(Any p0) { return invoke<Any>(0xA5B94DF8AF058F46, p0); }
static void WAYPOINT_PLAYBACK_PAUSE(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0x0F342546AA06FED5, p0, p1, p2, p3); }
static void WAYPOINT_PLAYBACK_RESUME(Any p0, BOOL p1, Any p2, Any p3) { invoke<Void>(0x244F70C84C547D2D, p0, p1, p2, p3); }
static void WAYPOINT_PLAYBACK_OVERRIDE_SPEED(Any p0, Any p1, Any p2, Any p3, Any p4) { invoke<Void>(0x7D7D2B47FA788E85, p0, p1, p2, p3, p4); }
static void WAYPOINT_PLAYBACK_USE_DEFAULT_SPEED(Any p0) { invoke<Void>(0x6599D834B12D0800, p0); }
static Any GET_PED_WAYPOINT_OVERRIDE_SPEED(Any p0) { return invoke<Any>(0xD39A2F3E7FCAFF08, p0); }
static void USE_WAYPOINT_RECORDING_AS_ASSISTED_MOVEMENT_ROUTE(Any p0, Any p1, Any p2, Any p3, Any p4) { invoke<Void>(0x5A353B8E6B1095B5, p0, p1, p2, p3, p4); }
static void WAYPOINT_PLAYBACK_START_AIMING_AT_PED(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0x20E330937C399D29, p0, p1, p2, p3); }
static void WAYPOINT_PLAYBACK_START_AIMING_AT_ENTITY(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0x4F158205E0C74385, p0, p1, p2, p3); }
static void WAYPOINT_PLAYBACK_START_AIMING_AT_COORD(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5) { invoke<Void>(0x8968400D900ED8B3, p0, p1, p2, p3, p4, p5); }
static void WAYPOINT_PLAYBACK_START_SHOOTING_AT_PED(Any p0, Any p1, Any p2, Any p3, Any p4) { invoke<Void>(0xE70BA7B90F8390DC, p0, p1, p2, p3, p4); }
static void WAYPOINT_PLAYBACK_START_SHOOTING_AT_ENTITY(Any p0, Any p1, Any p2, Any p3, Any p4) { invoke<Void>(0x4AF458F71C1196D2, p0, p1, p2, p3, p4); }
static void WAYPOINT_PLAYBACK_START_SHOOTING_AT_COORD(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6) { invoke<Void>(0x057A25CFCC9DB671, p0, p1, p2, p3, p4, p5, p6); }
...
static Any _0x5C885E0978B6AD60(Any p0, Any p1, Any p2, Any p3) { return invoke<Any>(0x5C885E0978B6AD60, p0, p1, p2, p3); }
...
static void SET_ENABLE_SPEED_RESTRAIN_FOR_WAYPOINT_RECORDING_LEADER(Any p0, Any p1) { invoke<Void>(0x295F03DC97BEEBC1, p0, p1); }
static void SET_UP_SPEED_RESTRAIN_INFORMATION_FOR_PLAYER_FOLLOWER(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8) { invoke<Void>(0xB5C51DD544F14F58, p0, p1, p2, p3, p4, p5, p6, p7, p8); }
static void TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8, Any p9, Any p10) { invoke<Void>(0x3123FAA6DB1CF7ED, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10); }
static void _0x041D17A9E221AE30(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8, Any p9) { invoke<Void>(0x041D17A9E221AE30, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9); }
...
static void TASK_SET_STEALTH_MOVEMENT(Ped ped, BOOL p1, Any p2, BOOL p3) { invoke<Void>(0x4C3FA937B44A90FA, ped, p1, p2, p3); }
static void TASK_SET_CROUCH_MOVEMENT(Ped ped, BOOL p1, Any p2, BOOL p3) { invoke<Void>(0x17293C633C8AC019, ped, p1, p2, p3); }
static void TASK_FORCE_MOTION_STATE(Ped ped, Hash state, BOOL p2) { invoke<Void>(0x4F056E1AFFEF17AB, ped, state, p2); }
static void TASK_MOVE_NETWORK_BY_NAME(Ped ped, const char* task, float multiplier, BOOL p3, const char* animDict, int flags) { invoke<Void>(0x2D537BA194896636, ped, task, multiplier, p3, animDict, flags); }
static void _0x139805C2A67C4795(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6) { invoke<Void>(0x139805C2A67C4795, p0, p1, p2, p3, p4, p5, p6); }
static void _0x7B6A04F98BBAFB2C(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8, Any p9, Any p10, Any p11, Any p12, Any p13, Any p14) { invoke<Void>(0x7B6A04F98BBAFB2C, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14); }
static void TASK_MOVE_NETWORK_ADVANCED_BY_NAME_WITH_INIT_PARAMS_ATTACHED(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8, Any p9, Any p10, Any p11, Any p12, Any p13, Any p14, Any p15, Any p16, Any p17) { invoke<Void>(0xF92171093BCABED4, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15, p16, p17); }
...
static void REQUEST_TASK_MOVE_NETWORK_STATE_TRANSITION(Ped ped, const char* name) { invoke<Void>(0xD01015C7316AE176, ped, name); }
...
static void _0x099D4A855D53B03B(Any p0, Any p1, Any p2) { invoke<Void>(0x099D4A855D53B03B, p0, p1, p2); }
...
static void _0x4662BFE01938D98D(Any p0, Any p1, Any p2, Any p3, Any p4) { invoke<Void>(0x4662BFE01938D98D, p0, p1, p2, p3, p4); }
static Any _0x844CEEE428EA35B0(Any p0, Any p1) { return invoke<Any>(0x844CEEE428EA35B0, p0, p1); }
static BOOL GET_TASK_MOVE_NETWORK_EVENT(Ped ped, const char* eventName) { return invoke<BOOL>(0xB4F47213DF45A64C, ped, eventName); }
static void _0x9585FF23C4B8EDE0(Any p0, Any p1) { invoke<Void>(0x9585FF23C4B8EDE0, p0, p1); }
...
static Any _0xF330A5C062B29BED(Any p0) { return invoke<Any>(0xF330A5C062B29BED, p0); }
...
static void TASK_DUEL(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8, Any p9, Any p10) { invoke<Void>(0x5D5B0D5BC3626E5A, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10); }
...
static void _0x748D5E0D2A1A4C61(Any p0, Any p1, Any p2) { invoke<Void>(0x748D5E0D2A1A4C61, p0, p1, p2); }
static void _0xEED08A3A98B847E2(Any p0, Any p1, Any p2) { invoke<Void>(0xEED08A3A98B847E2, p0, p1, p2); }
...
static void TASK_PLACE_CARRIED_ENTITY_AT_COORD(Ped p0, Ped p1, float p2, float p3, float p4, float p5, int p6) { invoke<Void>(0xC7F0B43DCDC57E3D, p0, p1, p2, p3, p4, p5, p6); }
static void TASK_PLACE_CARRIED_ENTITY_ON_MOUNT(Ped p0, Ped p1, Ped p2, float p3) { invoke<Void>(0x6D3D87C57B3D52C7, p0, p1, p2, p3); }
static void TASK_DUMP_CARRIABLE_FROM_PARENT(Any p0, Any p1, Any p2) { invoke<Void>(0x17CA98707B15926A, p0, p1, p2); }
...
static void TASK_PICKUP_CARRIABLE_ENTITY(Ped p0, Ped p1) { invoke<Void>(0x502EC17B1BED4BFA, p0, p1); }
static void TASK_HOGTIE_TARGET_PED(Any p0, Any p1) { invoke<Void>(0x27829AFD3E03AC1A, p0, p1); }
static void _TASK_CUT_FREE_HOGTIED_TARGET_PED(Any p0, Any p1) { invoke<Void>(0x81D16C4FF3A77ADF, p0, p1); }
static void _TASK_CUT_FREE_HOGTIED_TARGET_PED_2(Any p0, Any p1, Any p2) { invoke<Void>(0x525421A507216084, p0, p1, p2); }
static void _0xAB591AE6B48B913E(Any p0, Any p1) { invoke<Void>(0xAB591AE6B48B913E, p0, p1); }
static Any _0x4687E69D258BBE41(Any p0) { return invoke<Any>(0x4687E69D258BBE41, p0); }
static Any _0x73F0D0327BFA0812(Any p0) { return invoke<Any>(0x73F0D0327BFA0812, p0); }
static Any _0x5E5D96BE25E9DF68(Any p0) { return invoke<Any>(0x5E5D96BE25E9DF68, p0); }
static Any _0x5B4BBE80AD5972DC(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7) { return invoke<Any>(0x5B4BBE80AD5972DC, p0, p1, p2, p3, p4, p5, p6, p7); }
static void _0x5758B1EE0C3FD4AC(Any p0, Any p1) { invoke<Void>(0x5758B1EE0C3FD4AC, p0, p1); }
...
static void TASK_LOOT_ENTITY(Any p0, Any p1) { invoke<Void>(0x48FAE038401A2888, p0, p1); }
static void TASK_BREAK_VEHICLE_DOOR_LOCK(Any p0, Any p1) { invoke<Void>(0xBB28D1BC9EA8A6A5, p0, p1); }
static void TASK_LOOT_NEAREST_ENTITY(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5) { invoke<Void>(0xCF1501CBC4059412, p0, p1, p2, p3, p4, p5); }
static void TASK_LASSO_PED(Any p0, Any p1) { invoke<Void>(0xC716EB2BD16370A3, p0, p1); }
static void TASK_HOGTIEABLE(Any p0) { invoke<Void>(0x6AFD8FE0D723328F, p0); }
static void _0x79559BAD83CCD038(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5) { invoke<Void>(0x79559BAD83CCD038, p0, p1, p2, p3, p4, p5); }
static void _0x722D6A49200174FE(Any p0, Any p1, Any p2, Any p3, Any p4) { invoke<Void>(0x722D6A49200174FE, p0, p1, p2, p3, p4); }
...
static void _0x8E1DDE26D270CC5E(Any p0, Any p1) { invoke<Void>(0x8E1DDE26D270CC5E, p0, p1); }
static void _0xA6A76D666A281F2D(Any p0, Any p1) { invoke<Void>(0xA6A76D666A281F2D, p0, p1); }
static void _0xA21AA2F0C2180125(Any p0, Any p1) { invoke<Void>(0xA21AA2F0C2180125, p0, p1); }
...
static void _0x816A3ACD265E2297(Any p0, Any p1) { invoke<Void>(0x816A3ACD265E2297, p0, p1); }
static void _0x4E806A395D43A458(Any p0) { invoke<Void>(0x4E806A395D43A458, p0); }
static void _0x545BF19F86E80F11(Any p0, Any p1, Any p2) { invoke<Void>(0x545BF19F86E80F11, p0, p1, p2); }
static Any _0x559A6F8C5133B4EE(Any p0, Any p1) { return invoke<Any>(0x559A6F8C5133B4EE, p0, p1); }
static Any _0x11CD066F54DA0133(Any p0) { return invoke<Any>(0x11CD066F54DA0133, p0); }
static void _0x9ADDBB9242179D56(Any p0, Any p1) { invoke<Void>(0x9ADDBB9242179D56, p0, p1); }
static Any _0x4ECCC2815CA79AE2(Any p0) { return invoke<Any>(0x4ECCC2815CA79AE2, p0); }
static void _0xAA0AF6025160243A(Any p0, Any p1) { invoke<Void>(0xAA0AF6025160243A, p0, p1); }
static Any _0x1BF9D36A5EAFFBAE(Any p0, Any p1, Any p2) { return invoke<Any>(0x1BF9D36A5EAFFBAE, p0, p1, p2); }
static Any _0x6AFD84AEAA3EA538(Any p0) { return invoke<Any>(0x6AFD84AEAA3EA538, p0); }
static void _0xBD1C3C0F271C39D3(Any p0, Any p1) { invoke<Void>(0xBD1C3C0F271C39D3, p0, p1); }
static void _0x1ECF56C040FD839C(Any p0, Any p1) { invoke<Void>(0x1ECF56C040FD839C, p0, p1); }
static void _0xF40A109B4B79A848(Any p0, Any p1, Any p2) { invoke<Void>(0xF40A109B4B79A848, p0, p1, p2); }
static Any _0xEFC4303DDC6E60D3(Any p0) { return invoke<Any>(0xEFC4303DDC6E60D3, p0); }
...
static void TASK_TURN_TO_FACE_CLOSEST_PED(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0x84179419DBDD36F2, p0, p1, p2, p3); }
static Any TASK_CONFRONT(Any p0, Any p1, Any p2) { return invoke<Any>(0x3A2A2071DF5CC569, p0, p1, p2); }
static Any TASK_POLICE(Any p0, Any p1) { return invoke<Any>(0x87BE56724650408E, p0, p1); }
static Any TASK_MELEE(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7) { return invoke<Any>(0x482C99D0B38D1B0A, p0, p1, p2, p3, p4, p5, p6, p7); }
static Any TASK_GRAPPLE(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6) { return invoke<Any>(0x779A2FFACEFAEA7B, p0, p1, p2, p3, p4, p5, p6); }
static Any _TASK_INTIMIDATED(Any p0, Any p1, Any p2, Any p3, Any p4) { return invoke<Any>(0x648B75D44930D6BD, p0, p1, p2, p3, p4); }
static Any _TASK_INTIMIDATED_2(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8) { return invoke<Any>(0x933ACC1A1771A288, p0, p1, p2, p3, p4, p5, p6, p7, p8); }
...
static void _0x41D1331AFAD5A091(Any p0, Any p1, Any p2) { invoke<Void>(0x41D1331AFAD5A091, p0, p1, p2); }
static void _0x801BD27403F3CBA0(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0x801BD27403F3CBA0, p0, p1, p2, p3); }
static void _0x0FE797DD9F70DFA6(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0x0FE797DD9F70DFA6, p0, p1, p2, p3); }
static void TASK_PERSISTENT_CHARACTER(Any p0) { invoke<Void>(0x4391700CBD89C3D8, p0); }
static void _0xFC7F71CF49F70B6B(Any p0) { invoke<Void>(0xFC7F71CF49F70B6B, p0); }
static void _0xE01F55B2896F6B37(Any p0, Any p1) { invoke<Void>(0xE01F55B2896F6B37, p0, p1); }
...
static Any _0xF3735ACD11ACD500(Any p0, Any p1) { return invoke<Any>(0xF3735ACD11ACD500, p0, p1); }
static Any _0xF3735ACD11ACD501(Any p0, Any p1) { return invoke<Any>(0xF3735ACD11ACD501, p0, p1); }
static void TASK_SWAP_FISHING_BAIT(Any p0, Any p1, Any p2) { invoke<Void>(0x2C28AC30A72722DA, p0, p1, p2); }
static void _0x9B0C7FA063E67629(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0x9B0C7FA063E67629, p0, p1, p2, p3); }
...
static Any _0xB520DBDA7FCF573F(Any p0) { return invoke<Any>(0xB520DBDA7FCF573F, p0); }
static void _0x31BB338F64D5C861(Any p0, Any p1) { invoke<Void>(0x31BB338F64D5C861, p0, p1); }
static void _0x517D01BF27B682D1(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6) { invoke<Void>(0x517D01BF27B682D1, p0, p1, p2, p3, p4, p5, p6); }
static void _0x88FD60D846D9CD63(Any p0) { invoke<Void>(0x88FD60D846D9CD63, p0); }
static void _0x9050DF2C53801208(Any p0, Any p1) { invoke<Void>(0x9050DF2C53801208, p0, p1); }
static void _0x22CDBF317C40A122(Any p0) { invoke<Void>(0x22CDBF317C40A122, p0); }
static void _TASK_EMOTE(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7) { invoke<Void>(0xB31A277C1AC7B7FF, p0, p1, p2, p3, p4, p5, p6, p7); }
static void _TASK_EMOTE_2(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7) { invoke<Void>(0x884E3436CC1F41DD, p0, p1, p2, p3, p4, p5, p6, p7); }
...
static void _0x59AEA4DC640814B9(Any p0, Any p1) { invoke<Void>(0x59AEA4DC640814B9, p0, p1); }
...
static Any _0xC276FE69DDA22BAD(Any p0) { return invoke<Any>(0xC276FE69DDA22BAD, p0); }
static Any _0x5F5B1B7E8E8F94C6(Any p0) { return invoke<Any>(0x5F5B1B7E8E8F94C6, p0); }
static void TASK_ENTER_COVER(Any p0) { invoke<Void>(0x4972A022AE6DAFA1, p0); }
static void TASK_EXIT_COVER(Any p0) { invoke<Void>(0x2BC4A6D92D140112, p0); }
...
static Any _0x8CBE916CFC64AD5C(Any p0) { return invoke<Any>(0x8CBE916CFC64AD5C, p0); }
...
// TRANSPORT
static void TASK_ENTER_TRANSPORT(Any* p0) { invoke<Void>(0xAEE3ADD08829CB6F, p0); }
static void TASK_EXIT_TRANSPORT(Any* p0) { invoke<Void>(0xC273A5B8488F7838, p0); }
...
static Hash _GET_CURRENT_WEATHER_HASH() { return invoke<Hash>(0x4BEB42AEBCA732E9); }
static Hash _GET_CURRENT_WEATHER_HASH_2() { return invoke<Hash>(0x51021D36F62AAA83); }
static void _0x0730E518486DEEC3(BOOL p0) { invoke<Void>(0x0730E518486DEEC3, p0); }
static void SET_WEATHER_TYPE(Hash p0, BOOL p1, BOOL p2, BOOL p3, float p4, BOOL p5) { invoke<Void>(0x59174F1AFE095B5A, p0, p1, p2, p3, p4, p5); }
...
static void FREEZE_WEATHER(BOOL p0) { invoke<Void>(0xD74ACDF7DB8114AF, p0); }
static void _0xDD560ABEF5D3784C(int* p0, int* p1) { invoke<Void>(0xDD560ABEF5D3784C, p0, p1); }
...
static void _FORCE_LIGHTNING_FLASH_AT_COORDS(float x, float y, float z) { invoke<Void>(0x67943537D179597C, x, y, z); }
...
static int _0x483B8C542103AD72() { return invoke<int>(0x483B8C542103AD72); }
static int _GET_SYSTEM_TIME() { return invoke<int>(0xBE7F225417E35A7C); }
static int _GET_NUMBER_OF_MICROSECONDS_SINCE_LAST_CALL() { return invoke<int>(0xB0CE5E5ED8BB3581); }
static int _GET_SCRIPT_TIME_WITHIN_FRAME_IN_MICROSECONDS() { return invoke<int>(0x63219768C586667C); }
static void _RESET_SCRIPT_TIME_WITHIN_FRAME() { invoke<Void>(0x1411A7CBC3A6EB7B); }
...
static void PAUSE_DEATH_ARREST_RESTART(BOOL disableRespawn) { invoke<Void>(0x66AB6B6C7E72F393, disableRespawn); }
...
static void _SHOOT_SINGLE_BULLET_BETWEEN_COORDS_IGNORE_ENTITY_NEW(Any* p0) { invoke<Void>(0xCBC9A21F6A2A679C, p0); }
...
static BOOL _SHOULD_USE_24_HOUR_CLOCK() { return invoke<BOOL>(0x0177CF20345F44DD); }
...
static BOOL _DOES_STRING_EXIST_IN_STRING(Any* p0, Any* p1) { return invoke<BOOL>(0x9382D5D43D2AA6FF, p0, p1); }
...
static void _INT_TO_STRING(Any p0, Any* p1, Any* p2) { invoke<Void>(0xCF11C0CEB40C401B, p0, p1, p2); }
...
template<typename... Args> static char* CREATE_STRING(int flags, char* textTemplate, Args... args) { return invoke<char*>(0xFA925AC00EB830B9, flags, textTemplate, args...); } // 0xFA925AC00EB830B9 b1207
...
static void _0xD4958E8CF0DE0DD0(int p0) { invoke<Void>(0xD4958E8CF0DE0DD0, p0); }
...
static void _COPY_MEMORY(Any* p0, Any* p1, Any p2) { invoke<Void>(0xF7AC7DC0DEE7C9BE, p0, p1, p2); }
...
static Any ADD_POP_MULTIPLIER_AREA(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8, BOOL p9) { return invoke<Any>(0x5EBDA1A3B8CB5EF7, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9); }
static BOOL DOES_POP_MULTIPLIER_AREA_EXIST(Any p0) { return invoke<BOOL>(0x03BA619C81A646B3, p0); }
static void REMOVE_POP_MULTIPLIER_AREA(Any p0, BOOL p1) { invoke<Void>(0x88CB484364EFB37A, p0, p1); }
...
static void _CANCEL_ONSCREEN_KEYBOARD() { invoke<Void>(0x58A39BE597CE99CD); }
...
static void _START_BENCHMARK_RECORDING() { invoke<Void>(0x29D1F6DF864A094E); }
static void _STOP_BENCHMARK_RECORDING() { invoke<Void>(0xB89AEC71AFF2B599); }
static void _RESET_BENCHMARK_RECORDING() { invoke<Void>(0xECBABD0307FB216F); }
static void _SAVE_BENCHMARK_RECORDING() { invoke<Void>(0xF4743E2ECC02B3DA); }
static BOOL _UI_IS_SINGLEPLAYER_PAUSE_MENU_ACTIVE() { return invoke<BOOL>(0x4FFA0386A6216113); }
static int _GET_BENCHMARK_ITERATIONS_FROM_COMMAND_LINE() { return invoke<int>(0x22FC52CF470CC98D); }
static int _GET_BENCHMARK_PASS_FROM_COMMAND_LINE() { return invoke<int>(0x9297DACF3A2CDFF7); }
...
static Any _0xBDC6E364C9C78178(Any p0) { return invoke<Any>(0xBDC6E364C9C78178, p0); }
static int _GET_SCRIPT_HANDLE_TYPE(ScrHandle handle) { return invoke<int>(0xDC8D2FF478DF9553, handle); }
...
// ATTRIBUTE
static void SET_ATTRIBUTE_BASE_RANK(Any p0, Any p1, Any p2) { invoke<Void>(0x5DA12E025D47D4E5, p0, p1, p2); }
static Any GET_ATTRIBUTE_RANK(Any p0, Any p1) { return invoke<Any>(0xA4C8E23E29040DE0, p0, p1); }
static Any GET_ATTRIBUTE_BASE_RANK(Any p0, Any p1) { return invoke<Any>(0x147149F2E909323C, p0, p1); }
static Any GET_ATTRIBUTE_BONUS_RANK(Any p0, Any p1) { return invoke<Any>(0x0EFA71F4B4330E04, p0, p1); }
static Any GET_MAX_ATTRIBUTE_RANK(Any p0, Any p1) { return invoke<Any>(0x704674A0535A471D, p0, p1); }
static void SET_ATTRIBUTE_BONUS_RANK(Any p0, Any p1, Any p2) { invoke<Void>(0x920F9488BD115EFB, p0, p1, p2); }
static Any GET_DEFAULT_ATTRIBUTE_RANK(Any p0, Any p1) { return invoke<Any>(0x958DD43D41F89A47, p0, p1); }
static Any GET_DEFAULT_MAX_ATTRIBUTE_RANK(Any p0, Any p1) { return invoke<Any>(0x7C059C55AD940CB4, p0, p1); }
static void ADD_ATTRIBUTE_POINTS(Any p0, Any p1, Any p2) { invoke<Void>(0x75415EE0CB583760, p0, p1, p2); }
static void SET_ATTRIBUTE_POINTS(Any p0, Any p1, Any p2) { invoke<Void>(0x09A59688C26D88DF, p0, p1, p2); }
static Any GET_ATTRIBUTE_POINTS(Any p0, Any p1) { return invoke<Any>(0x219DA04BAA9CB065, p0, p1); }
static Any GET_MAX_ATTRIBUTE_POINTS(Any p0, Any p1) { return invoke<Any>(0x223BF310F854871C, p0, p1); }
static void _0xC6258F41D86676E0(Any p0, Any p1, Any p2) { invoke<Void>(0xC6258F41D86676E0, p0, p1, p2); }
static int _GET_PED_CORE_VALUE(Ped ped, int coreIndex) { return invoke<int>(0x36731AC041289BB1, ped, coreIndex); }
static Any GET_DEFAULT_ATTRIBUTE_POINTS_NEEDED_FOR_RANK(Any p0, Any p1, Any p2) { return invoke<Any>(0x94A7F191DB49A44D, p0, p1, p2); }
static void _0xF6A7C08DF2E28B28(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0xF6A7C08DF2E28B28, p0, p1, p2, p3); }
static void ENABLE_ATTRIBUTE_OVERPOWER(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0x4AF5A4C7B9157D14, p0, p1, p2, p3); }
static void DISABLE_ATTRIBUTE_OVERPOWER(Any p0, Any p1) { invoke<Void>(0xF8DAC3D85636C241, p0, p1); }
static Any _0x103C2F885ABEB00B(Any p0, Any p1) { return invoke<Any>(0x103C2F885ABEB00B, p0, p1); }
static Any _0x200373A8DF081F22(Any p0, Any p1) { return invoke<Any>(0x200373A8DF081F22, p0, p1); }
static Any _0x4C9F782180712742(Any p0, Any p1) { return invoke<Any>(0x4C9F782180712742, p0, p1); }
static Any _0xB429F58803D285B1(Any p0, Any p1) { return invoke<Any>(0xB429F58803D285B1, p0, p1); }
...
static Any MISSIONDATA_GET_REPLAY_STATE(Any p0) { return invoke<Any>(0x8C32D86E9556ED86, p0); }
static void MISSIONDATA_SET_RATING_SCORES(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0x12F65317708749A5, p0, p1, p2, p3); }
static void MISSIONDATA_SET_HIGH_SCORE(Any p0, Any p1) { invoke<Void>(0x3A04F0169DA87A9D, p0, p1); }
static Any MISSIONDATA_GET_HIGH_SCORE(Any p0) { return invoke<Any>(0x9AABABF8313C3516, p0); }
...
// ANIMALTUNING
static Any GET_SPECIES_TUNING_FLOAT_PARAM(Any p0, Any p1, Any p2) { return invoke<Any>(0xE108489621422F91, p0, p1, p2); }
static void SET_SPECIES_TUNING_FLOAT_PARAM(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0x963240B6C252BA49, p0, p1, p2, p3); }
static void SET_SPECIES_TUNING_BOOL_PARAM(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0x6D1D94C2459B42EE, p0, p1, p2, p3); }
static Any GET_ANIMAL_TUNING_FLOAT_PARAM(Any p0, Any p1) { return invoke<Any>(0x4BC3ECFDA0297E27, p0, p1); }
static void SET_ANIMAL_TUNING_FLOAT_PARAM(Any p0, Any p1, Any p2) { invoke<Void>(0xCBDA22C87977244F, p0, p1, p2); }
static Any GET_ANIMAL_TUNING_BOOL_PARAM(Any p0, Any p1) { return invoke<Any>(0x1C1993824A396603, p0, p1); }
static void SET_ANIMAL_TUNING_BOOL_PARAM(Any p0, Any p1, Any p2) { invoke<Void>(0x9FF1E042FA597187, p0, p1, p2); }
...
static int _0xF8B48A361DC388AE(Ped ped) { return invoke<Any>(0xF8B48A361DC388AE, ped); }
...
static void TASK_FLOCK(Any p0, Any p1) { invoke<Void>(0x933E5D31A7D13069, p0, p1); }
...
static void _0xCE5D0FFE83939AF1(int p0, char* p1, char* p2, int p3) { invoke<Void>(0xCE5D0FFE83939AF1, p0, p1, p2, p3); }
...
static BOOL _0x84848E1C0FC67DBB(int p0) { return invoke<BOOL>(0x84848E1C0FC67DBB, p0); }
...
static void STOP_CURRENT_PLAYING_SPEECH(Ped ped, Any p1) { invoke<Void>(0x79D2F0E66F81D90D, ped, p1); }
...
static void PLAY_ANIMAL_VOCALIZATION(Entity entity, int unk, char* speech) { invoke<Void>(0xEE066C7006C49C0A, entity, unk, speech); }
static BOOL IS_ANIMAL_VOCALIZATION_PLAYING(Any p0) { return invoke<BOOL>(0xC265DF9FB44A9FBD, p0); }
...
static void PLAY_STREAM_FROM_POSITION(float x, float y, float z, Any p3) { invoke<Void>(0x21442F412E8DE56B, x, y, z, p3); }
...
static Any _GET_WEAPONTYPE_MODEL(Hash weaponHash) { return invoke<Any>(0xF70825EB340E7D15, weaponHash); }
...
static Any _GIVE_WEAPON_TO_PED(Ped ped, Hash weaponHash, int ammoCount, BOOL equipNow, BOOL p4, uint weaponGroup, BOOL p6, float p7, float p8, Any p9, BOOL p10, float p11, BOOL p12) { return invoke<Any>(0x5E3BDDBCB83F3D84, ped, weaponHash, ammoCount, equipNow, p4, weaponGroup, p6, p7, p8, p9, p10, p11, p12); }
...
static Any _0xD8402B858F4DDD88(char* p0, Any p1) { return invoke<Any>(0xD8402B858F4DDD88, p0, p1); }
...
static char* _GET_LABEL_TEXT_3(int labelHash) { return invoke<char*>(0xBD5DD5EAE2B6CE14, labelHash); }
...
static void _JOURNAL_WRITE_ENTRY(Any p0) { invoke<Void>(0x6DFDD665E416B093, p0); }
...
static Any _JORUNAL_GET_TEXTURE_WITH_LAYOUT(Any p0, Any p1, Any p2) { return invoke<Any>(0x62CC549B3B8EA2AA, p0, p1, p2); }
static void _JORUNAL_MARK_READ(Any p0) { invoke<Void>(0xE4509BABE59BD24E, p0); }
static void _JORUNAL_CLEAR_ALL_PROGRESS() { invoke<Void>(0xF402978DE6F88D6E); }
...
static int _CREATE_PROMPT(int button_id, const char* text, int p2, int p3, int p4, int p5) { return invoke<int>(0x29FA7910726C3889, button_id, text, p2, p3, p4, p5); }
static int _BEGIN_REGISTER_PROMPT() { return invoke<int>(0x04F97DE45A519419); }
static void _END_REGISTER_PROMPT(int p0) { invoke<Void>(0xF7AA2696A22AD8B9, p0); }
static void _PROMPT_SET_PRIORITY(int p0, Any p1) { invoke<Void>(0xCA24F528D0D16289, p0, p1); }
static Any _PROMPT_SET_CONTROL_ACTION(int p0, Hash p1) { return invoke<Any>(0xB5352B7494A08258, p0, p1); }
static void _PROMPT_SET_ALLOWED_ACTION(Any p0, Any p1) { invoke<Void>(0x565C1CE183CB0EAF, p0, p1); }
static void _PROMPT_SET_STANDARD_MODE(int p0, Any p1) { invoke<Void>(0xCC6656799977741B, p0, p1); }
static Any _PROMPT_HAS_STANDARD_MODE_COMPLETED(Any p0, Any p1) { return invoke<Any>(0xC92AC953F0A982AE, p0, p1); }
static void _PROMPT_SET_PRESSED_TIMED_MODE(Any p0, Any p1) { invoke<Void>(0x1473D3AF51D54276, p0, p1); }
static Any _PROMPT_HAS_PRESSED_TIMED_MODE_COMPLETED(Any p0) { return invoke<Any>(0x3CE854D250A88DAF, p0); }
static Any _PROMPT_HAS_PRESSED_TIMED_MODE_FAILED(Any p0) { return invoke<Any>(0x1A17B9ECFF617562, p0); }
static void _PROMPT_SET_HOLD_MODE(Any p0, Any p1) { invoke<Void>(0x94073D5CA3F16B7B, p0, p1); }
static void _PROMPT_SET_STANDARDIZED_HOLD_MODE(Any p0, Any p1) { invoke<Void>(0x74C7D7B72ED0D3CF, p0, p1); }
static void _PROMPT_SET_HOLD_INDEFINITELY_MODE(Any p0) { invoke<Void>(0xEA5CCF4EEB2F82D1, p0); }
static void _PROMPT_SET_HOLD_AUTO_FILL_MODE(Any p0, Any p1, Any p2) { invoke<Void>(0x3CE932E737C145D6, p0, p1, p2); }
static void _0xA3F2149AA24F3D8E(Any p0, Any p1, Any p2) { invoke<Void>(0xA3F2149AA24F3D8E, p0, p1, p2); }
static Any _PROMPT_HAS_HOLD_AUTO_FILL_MODE(Any p0) { return invoke<Any>(0x8010BEBD0D5ED5BC, p0); }
static Any _0xB60C9F9ED47ABB76(Any p0) { return invoke<Any>(0xB60C9F9ED47ABB76, p0); }
static Any _PROMPT_IS_HOLD_MODE_RUNNING(Any p0) { return invoke<Any>(0xC7D70EAEF92EFF48, p0); }
static Any _PROMPT_HAS_HOLD_MODE_COMPLETED(Any p0) { return invoke<Any>(0xE0F65F0640EF0617, p0); }
static Any _0x81801291806DBC50(Any p0) { return invoke<Any>(0x81801291806DBC50, p0); }
static void _PROMPT_SET_MASH_MODE(Any p0, Any p1) { invoke<Void>(0xDF6423BF071C7F71, p0, p1); }
static void _PROMPT_SET_MASH_INDEFINITELY_MODE(Any p0) { invoke<Void>(0x7B66E89312727274, p0); }
static void _PROMPT_SET_MASH_WITH_RESISTANCE_MODE(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0xCD1BDFF15EFA79F5, p0, p1, p2, p3); }
static void _PROMPT_SET_MASH_WITH_RESISTANCE_CAN_FAIL_MODE(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0xDC0CB602DEADBA53, p0, p1, p2, p3); }
static void _PROMPT_SET_MASH_AUTO_FILL_MODE(Any p0, Any p1, Any p2) { invoke<Void>(0x6C39587D7CC66801, p0, p1, p2); }
static void _PROMPT_SET_MASH_MANUAL_MODE(Any p0, Any p1, Any p2, Any p3, Any p4) { invoke<Void>(0x32DF729D8BD3C1C6, p0, p1, p2, p3, p4); }
static void _PROMPT_SET_MASH_MANUAL_CAN_FAIL_MODE(Any p0, Any p1, Any p2, Any p3, Any p4) { invoke<Void>(0x179DCF71F705DA20, p0, p1, p2, p3, p4); }
...
static Any _PROMPT_HAS_MASH_MODE_COMPLETED(Any p0) { return invoke<Any>(0x845CE958416DC473, p0); }
static Any _PROMPT_HAS_MASH_MODE_FAILED(Any p0) { return invoke<Any>(0x25B18E530CF39D6F, p0); }
static Any _PROMPT_GET_MASH_MODE_PROGRESS(Any p0) { return invoke<Any>(0x8A9585293863B8A5, p0); }
static void _PROMPT_SET_MASH_MANUAL_MODE_INCREASE_PER_PRESS(Any p0, Any p1) { invoke<Void>(0xA0D1D79C6036A855, p0, p1); }
static void _PROMPT_SET_MASH_MANUAL_MODE_DECAY_SPEED(Any p0, Any p1) { invoke<Void>(0x7D393C247FB9B431, p0, p1); }
static void _PROMPT_SET_MASH_MANUAL_MODE_PRESSED_GROWTH_SPEED(Any p0, Any p1) { invoke<Void>(0x56DBB26F98582C29, p0, p1); }
static void _PROMPT_SET_ROTATE_MODE(Any p0, Any p1, Any p2) { invoke<Void>(0x7ABE7095FB3D2581, p0, p1, p2); }
static void _PROMPT_SET_TARGET_MODE(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0x5F6503D9CD2754EB, p0, p1, p2, p3); }
static void _PROMPT_SET_TARGET_MODE_TARGET(Any p0, Any p1, Any p2) { invoke<Void>(0x5E019C45DD3B6A14, p0, p1, p2); }
static void _PROMPT_SET_TARGET_MODE_PROGRESS(Any p0, Any p1) { invoke<Void>(0x00123054BEC8A30F, p0, p1); }
static void _PROMPT_SET_BEAT_MODE(Any p0, Any p1) { invoke<Void>(0xF957A1654C6322FE, p0, p1); }
static Any _PROMPT_WAS_BEAT_MODE_PRESSED_IN_TIME_WINDOW(Any p0) { return invoke<Any>(0x1FE4788AB1430C55, p0); }
static void _PROMPT_SET_BEAT_MODE_GRAYED_OUT(Any p0, Any p1) { invoke<Void>(0xB487A4936FBF40AC, p0, p1); }
static void _PROMPT_RESTART_MODES(Any p0) { invoke<Void>(0xDC6C55DFA2C24EE5, p0); }
static void _PROMPT_SET_SPINNER_SPEED(Any p0, Any p1) { invoke<Void>(0xAC6586A7FDCD4B68, p0, p1); }
static void _PROMPT_SET_SPINNER_POSITION(Any p0, Any p1) { invoke<Void>(0x832CB510DE546282, p0, p1); }
static void _PROMPT_SET_URGENT_PULSING_ENABLED(Any p0, Any p1) { invoke<Void>(0xC5F428EE08FA7F2C, p0, p1); }
static Any _PROMPT_GET_URGENT_PULSING_ENABLED(Any p0) { return invoke<Any>(0x1FBA0DABECDDB52B, p0); }
static void _PROMPT_SET_TAG(int p0, char* p1) { invoke<Void>(0xDEC85C174751292B, p0, p1); }
static Any _PROMPT_GET_GROUP_ID_FOR_TARGET_ENTITY(Any p0) { return invoke<Any>(0xB796970BD125FCE8, p0); }
static Any _PROMPT_GET_GROUP_ID_FOR_SCENARIO_POINT(Any p0, Any p1) { return invoke<Any>(0xCB73D7521E7103F0, p0, p1); }
static void _PROMPT_SET_GROUP(Any p0, Any p1, Any p2) { invoke<Void>(0x2F11D3A254169EA4, p0, p1, p2); }
static void _PROMPT_REMOVE_GROUP(Any p0, Any p1) { invoke<Void>(0x4E52C800A28F7BE8, p0, p1); }
static Any _PROMPT_SET_ACTIVE_GROUP_THIS_FRAME(Any p0, const char* p1, Any p2, Any p3, Any p4, Any p5) { return invoke<Any>(0xC65A45D4453C2627, p0, p1, p2, p3, p4, p5); }
static Any _PROMPT_GET_GROUP_ACTIVE_PAGE(Any p0) { return invoke<Any>(0xC1FCC36C3F7286C8, p0); }
static Any _PROMPT_SET_AMBIENT_GROUP_THIS_FRAME(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6) { return invoke<Any>(0x315C81D760609108, p0, p1, p2, p3, p4, p5, p6); }
static Any _PROMPT_DOES_AMBIENT_GROUP_EXIST(Any p0) { return invoke<Any>(0xEB550B927B34A1BB, p0); }
static void _PROMPT_ADD_GROUP_LINK(Any p0, Any p1, Any p2) { invoke<Void>(0x684C96CC7C66E8EF, p0, p1, p2); }
static void _PROMPT_ADD_GROUP_RETURN_LINK(Any p0, Any p1) { invoke<Void>(0x837972ED28159536, p0, p1); }
static void _PROMPT_SET_TRANSPORT_MODE(int p0, Any p1) { invoke<Void>(0x876E4A35C73A6655, p0, p1); }
static void _0xF1622CE88A1946FB() { invoke<Void>(0xF1622CE88A1946FB); }
static void _PROMPT_DELETE(int p0) { invoke<Void>(0x00EDE88D4D13CF59, p0); }
static BOOL _PROMPT_IS_VALID(int p0) { return invoke<BOOL>(0x347469FBDD1589A9, p0); }
static BOOL _PROMPT_IS_ACTIVE(int p0) { return invoke<BOOL>(0x546E342E01DE71CF, p0); }
static void _PROMPT_SET_VISIBLE(int p0, BOOL p1) { invoke<Void>(0x71215ACCFDE075EE, p0, p1); }
static void _PROMPT_SET_ENABLED(int p0, BOOL p1) { invoke<Void>(0x8A0FB4D03A630D21, p0, p1); }
static void _PROMPT_SET_TEXT(int p0, const char* p1) { invoke<Void>(0x5DD02A8318420DD7, p0, p1); }
static void _PROMPT_SET_ATTRIBUTE(int p0, Any p1, Any p2) { invoke<Void>(0x560E76D5E2E1803F, p0, p1, p2); }
...
static void _0x4D107406667423BE(int p0, Entity p1) { invoke<Void>(0x4D107406667423BE, p0, p1); }
static void _PROMPT_SET_POSITION(int p0, float p1, float p2, float p3) { invoke<Void>(0xAE84C5EE2C384FB3, p0, p1, p2, p3); }
static void _0x0C718001B77CA468(int p0, float p1) { invoke<Void>(0x0C718001B77CA468, p0, p1); }
static BOOL _PROMPT_IS_PRESSED(int p0) { return invoke<BOOL>(0x21E60E230086697F, p0); }
static BOOL _PROMPT_IS_JUST_PRESSED(int p0) { return invoke<BOOL>(0x2787CC611D3FACC5, p0); }
static BOOL _PROMPT_IS_JUST_RELEASED(int p0) { return invoke<BOOL>(0x635CC82FA297A827, p0); }
static BOOL _PROMPT_IS_RELEASED(int p0) { return invoke<BOOL>(0xAFC887BA7A7756D6, p0); }
static void _PROMPT_GLOBAL_ENABLE_PROMPT_TYPE_THIS_FRAME(Any p0) { invoke<Void>(0x06565032897BA861, p0); }
static void _PROMPT_GLOBAL_DISABLE_PROMPT_TYPE_THIS_FRAME(Any p0) { invoke<Void>(0xFC094EF26DD153FA, p0); }
static void _PROMPT_GLOBAL_FILTER_CLEAR() { invoke<Void>(0x6A2F820452017EA2); }
static void _PROMPT_GLOBAL_SET_FAVOURED_PED_FOR_CONFLICT_RESOLUTION(Any p0) { invoke<Void>(0x530A428705BE5DEF, p0); }
static void _PROMPT_GLOBAL_CLEAR_FAVOURED_PED_FOR_CONFLICT_RESOLUTION() { invoke<Void>(0x51259AE5C72D4A1B); }
static Any _PROMPT_IS_ENABLED(Any p0) { return invoke<Any>(0x0D00EDDFB58B7F28, p0); }
static Any _0x1BE19185B8AFE299(Any p0) { return invoke<Any>(0x1BE19185B8AFE299, p0); }
static Any _0xD6BD313CFA41E57A(Any p0) { return invoke<Any>(0xD6BD313CFA41E57A, p0); }
static Any _PROMPT_SET_HORIZONTAL() { return invoke<Any>(0xD9459157EB22C895); }
static void _0x6095358C4142932A(Any p0) { invoke<Void>(0x6095358C4142932A, p0); }
static void _PROMPT_SET_ORDERING_AS_INPUT_TYPE(Any p0, Any p1) { invoke<Void>(0x2F385ECC5200938D, p0, p1); }
static Any _0xD877AF112AD2B41B(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5) { return invoke<Any>(0xD877AF112AD2B41B, p0, p1, p2, p3, p4, p5); }
static int CREATE_FAKE_MP_GAMER_TAG(Ped ped, const char* username, BOOL pointedClanTag, BOOL isRockstarClan, const char* clanTag, Any p5) { return invoke<int>(0x53CB4B502E1C57EA, ped, username, pointedClanTag, isRockstarClan, clanTag, p5); }
...
static Any _0x502E1591A504F843(Any p0, Any p1) { return invoke<Any>(0x502E1591A504F843, p0, p1); }
...
static void SET_MP_GAMER_TAG_NAME(int gamerTagId, const char* string) { invoke<Void>(0xEA6F4B8D4B4B5B3E, gamerTagId, string); }
static void _0x1EA716E0628A6F44(Any p0, Any p1) { invoke<Void>(0x1EA716E0628A6F44, p0, p1); }
static void SET_MP_GAMER_TAG_BIG_TEXT(int gamerTagId, const char* string) { invoke<Void>(0xA0D7CE5F83259663, gamerTagId, string); }
...
// UIAPPS
static BOOL _IS_APP_ACTIVE(Any p0) { return invoke<BOOL>(0x25B7A0206BDFAC76, p0); }
static Any _0xAC959AB99AAF3D9F() { return invoke<Any>(0xAC959AB99AAF3D9F); }
static BOOL _IS_APP_RUNNING(Any p0) { return invoke<BOOL>(0x4E511D093A86AD49, p0); }
static Any _IS_ANY_APP_RUNNING() { return invoke<Any>(0xDB30BEC7A7A5CBD3); }
static Any _0x96FD694FE5BE55DC(Any p0) { return invoke<Any>(0x96FD694FE5BE55DC, p0); }
static void _CLOSE_APP_BY_HASH(Any p0) { invoke<Void>(0x2FF10C9C3F92277E, p0); }
static void _CLOSE_APP_BY_HASH_IMMEDIATE(Any p0) { invoke<Void>(0x04428420A248A354, p0); }
static void _0x818C6CA9B659E8EC(Any* p0) { invoke<Void>(0x818C6CA9B659E8EC, p0); }
static void _CLOSE_APP(Any* p0) { invoke<Void>(0x3015635426D1B17C, p0); }
static void _CLOSE_ALL_APPS() { invoke<Void>(0xAD7B70F7230C5A12); }
static void _0x12769EEB8DBD7A7B() { invoke<Void>(0x12769EEB8DBD7A7B); }
static Any _LAUNCH_APP_BY_HASH_WITH_ENTRY(Any p0, Any p1) { return invoke<Any>(0xC1BCF31E975B3195, p0, p1); }
static Any _LAUNCH_APP_BY_HASH(Hash p0) { return invoke<Any>(0xC8FC7F4E4CF4F581, p0); }
static Any _LAUNCH_APP_WITH_ENTRY(Any* p0, Any* p1) { return invoke<Any>(0x7B2027BAC5C8EC89, p0, p1); }
static BOOL _0x16F47D434B6086BF(Any p0, Any p1) { return invoke<BOOL>(0x16F47D434B6086BF, p0, p1); }
static BOOL _CAN_LAUNCH_APP_BY_HASH(Any p0) { return invoke<BOOL>(0xE555EC27D65EDE80, p0); }
static BOOL _UIAPP_REQUEST_TRANSITION_BY_HASH(Any p0, Any p1) { return invoke<BOOL>(0x7689CD255655BFD7, p0, p1); }

// UIEVENTS
static BOOL _IS_EVENT_PENDING(Any p0) { return invoke<BOOL>(0x67ED5A7963F2F722, p0); }
static BOOL _0xE24E957294241444(Any p0, Any* p1) { return invoke<BOOL>(0xE24E957294241444, p0, p1); }
static BOOL _PEEK_EVENT(Any p0, Any* p1) { return invoke<BOOL>(0x90237103F27F7937, p0, p1); }
static void _POP_EVENT(Any p0) { invoke<Void>(0x8E8A2369F48EC839, p0); }
...
static void _LOG_CLEAR_ALL_ENTRIES() { invoke<Void>(0xB95B4EA6B1EDF035); }
...
static void _LOG_SET_CACHED_OBJECTIVE(char* p0) { invoke<Void>(0xFA233F8FE190514C, p0); }
static void _LOG_CLEAR_CACHED_OBJECTIVE() { invoke<Void>(0xDFF0D417277B41F8); }
...
static void _LOG_PRINT_CACHED_OBJECTIVE() { invoke<Void>(0xE9990552DEC71600); }
...
static int _POST_NOTIFICATION(Any* p0) { return invoke<int>(0x49E58FE6EF40B987, p0); }
...
static void PAUSE_CLOCK(BOOL toggle) { invoke<Void>(0x4D1A590C92BF377E, toggle); }
...
static BOOL IS_CONTROL_ENABLED(int inputGroup, Hash control) { return invoke<BOOL>(0x1CEA6BFDF248E5D9, inputGroup, control); }
static BOOL IS_CONTROL_PRESSED(int inputGroup, Hash contorl) { return invoke<BOOL>(0xF3A21BCD95725A4A, inputGroup, contorl); }
static BOOL IS_CONTROL_RELEASED(int inputGroup, Hash control) { return invoke<BOOL>(0x648EE3E7F38877DD, inputGroup, control); }
static BOOL IS_CONTROL_JUST_PRESSED(int inputGroup, Hash control) { return invoke<BOOL>(0x580417101DDB492F, inputGroup, control); }
static BOOL IS_CONTROL_JUST_RELEASED(int inputGroup, Hash control) { return invoke<BOOL>(0x50F940259D3841E6, inputGroup, control); }
static int GET_CONTROL_VALUE(int inputGroup, Hash control) { return invoke<int>(0xD95E79E8686D2C27, inputGroup, control); }
static float GET_CONTROL_NORMAL(int inputGroup, Hash control) { return invoke<float>(0xEC3C9B8D5327B563, inputGroup, control); }
static float _0x5B84D09CEC5209C5(int inputGroup, Hash control) { return invoke<float>(0x5B84D09CEC5209C5, inputGroup, control); }
static BOOL _SET_CONTROL_NORMAL(int inputGroup, Hash control, float amount) { return invoke<BOOL>(0xE8A25867FBA3B05E, inputGroup, control, amount); }
static BOOL IS_DISABLED_CONTROL_PRESSED(int inputGroup, Hash control) { return invoke<BOOL>(0xE2587F8CBBD87B1D, inputGroup, control); }
static BOOL IS_DISABLED_CONTROL_JUST_PRESSED(int inputGroup, Hash control) { return invoke<BOOL>(0x91AEF906BCA88877, inputGroup, control); }
static BOOL IS_DISABLED_CONTROL_JUST_RELEASED(int inputGroup, Hash control) { return invoke<BOOL>(0x305C8DCD79DA8B0F, inputGroup, control); }
static float GET_DISABLED_CONTROL_NORMAL(int inputGroup, Hash control) { return invoke<float>(0x11E65974A982637C, inputGroup, control); }
static float _0x4F8A26A890FD62FB(int inputGroup, Hash control) { return invoke<float>(0x4F8A26A890FD62FB, inputGroup, control); }
...
static void SET_INPUT_EXCLUSIVE(int inputGroup, Hash control) { invoke<Void>(0xEDE476E5EE29EDB1, inputGroup, control); }
static void DISABLE_CONTROL_ACTION(int inputGroup, Hash control, BOOL disable) { invoke<Void>(0xFE99B66D079CF6BC, inputGroup, control, disable); }
static void ENABLE_CONTROL_ACTION(int inputGroup, Hash control, BOOL enable) { invoke<Void>(0x351220255D64C155, inputGroup, control, enable); }
...
// DATABINDING
static Any _0x0C827D175F1292F2(char* p0) { return invoke<Any>(0x0C827D175F1292F2, p0); }
static Any _0x0C827D175F1292F3(Any p0, Any p1) { return invoke<Any>(0x0C827D175F1292F3, p0, p1); }
static Any _0xD7DB94AB78E8EBE4(char* p0, Any p1) { return invoke<Any>(0xD7DB94AB78E8EBE4, p0, p1); }
static Any _ADD_DATA_CONTAINER_FROM_PATH(char* p0, char* p1) { return invoke<Any>(0x0C827D175F1292F4, p0, p1); }
static Any _ADD_DATA_CONTAINER_BY_HASH(Any p0, Any p1) { return invoke<Any>(0x98BB14345BB68257, p0, p1); }
static Any _ADD_DATA_CONTAINER(Any p0, char* p1) { return invoke<Any>(0xEB4F9A3537EEABCD, p0, p1); }
static Any _ADD_DATA_BOOL_FROM_PATH(char* p0, char* p1, BOOL p2) { return invoke<Any>(0x37BB86A751148A6A, p0, p1, p2); }
static Any _ADD_DATA_BOOL_BY_HASH(Any p0, Any p1, BOOL p2) { return invoke<Any>(0xBC95D3AE2ECA70D6, p0, p1, p2); }
static Any _ADD_DATA_BOOL(Any p0, char* p1, BOOL p2) { return invoke<Any>(0x58BAA5F635DA2FF4, p0, p1, p2); }
...
static Any _ADD_DATA_FLOAT(Any p0, Any* p1, float p2) { return invoke<Any>(0x5154228273ADB9A6, p0, p1, p2); }
static Any _ADD_DATA_HASH_BY_HASH(Any p0, Any p1, Any p2) { return invoke<Any>(0x8E173DFB041993C6, p0, p1, p2); }
static Any _ADD_DATA_HASH(Any p0, char* p1, Hash p2) { return invoke<Any>(0x8538F1205D60ECA6, p0, p1, p2); }
static Any _0xA381DE86EE170C4A(Any* p0, char* p1, Any* p2) { return invoke<Any>(0xA381DE86EE170C4A, p0, p1, p2); }
static Any _ADD_DATA_STRING_BY_HASH(Any p0, Any p1, Any* p2) { return invoke<Any>(0xEAD09E76E22630C3, p0, p1, p2); }
static Any _ADD_DATA_STRING(Any p0, char* p1, char* p2) { return invoke<Any>(0x617FCA1C5652BBAD, p0, p1, p2); }
...
static Any _ADD_UI_ITEM_LIST_FROM_PATH(char* p0, char* p1) { return invoke<Any>(0xDB5B9A474148F699, p0, p1); }
static Any _ADD_UI_ITEM_LIST_BY_HASH(Any p0, Any p1) { return invoke<Any>(0x3C7799283325181B, p0, p1); }
static Any _ADD_UI_ITEM_LIST(Any p0, char* p1) { return invoke<Any>(0xFE74FA57E0CE6824, p0, p1); }
static void _INSERT_UI_ITEM_TO_LIST_FROM_CONTEXT_STRING_ALIAS(Any p0, Any p1, char* p2, Any p3) { invoke<Void>(0x5859E970794D92F3, p0, p1, p2, p3); }
static void _INSERT_UI_ITEM_TO_LIST_FROM_CONTEXT_HASH_ALIAS(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0xEE97A05C05F16E41, p0, p1, p2, p3); }
static void _INSERT_UI_ITEM_TO_LIST_FROM_PATH_STRING_ALIAS(Any p0, Any p1, Any* p2, Any* p3) { invoke<Void>(0x5740774F608E4FC8, p0, p1, p2, p3); }
...
static void _CLEAR_BINDING_ARRAY(Any p0) { invoke<Void>(0xA1F15C1D03DF802D, p0); }
...
static void _WRITE_DATA_BOOL(Any p0, BOOL p1) { invoke<Void>(0xAB888B4B91046770, p0, p1); }
...
// SYSTEM
static void _WAIT(int ms) { invoke<Void>(0x4EDE34FBADD967A6, ms); }
...
static char* _GET_GAME_BUILD_STRING() { return invoke<char*>(0x05A5F662AD35C573); }
