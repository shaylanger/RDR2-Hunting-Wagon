...
int menu_get_prompt_handle(int prompt_id, menu_prompt(&prompt)[MAX_MENU_PROMPTS] = menu_added_prompts);
char* menu_get_prompt_string(int prompt_id, menu_prompt(&prompt)[MAX_MENU_PROMPTS] = menu_added_prompts);
int menu_get_prompt_button(int prompt_id, menu_prompt(&prompt)[MAX_MENU_PROMPTS] = menu_added_prompts);
int menu_get_prompt_button_2(int prompt_id, menu_prompt(&prompt)[MAX_MENU_PROMPTS] = menu_added_prompts);
...
void menu_set_prompt_visible(int prompt_id, bool state, menu_prompt(&prompt)[MAX_MENU_PROMPTS] = menu_added_prompts);
void menu_set_prompt_text(int prompt_id, char* prompt_string, menu_prompt(&prompt)[MAX_MENU_PROMPTS] = menu_added_prompts);
void menu_set_prompt_button(int prompt_id, int prompt_button, menu_prompt(&prompt)[MAX_MENU_PROMPTS] = menu_added_prompts);
void menu_set_prompt_button_2(int prompt_id, int prompt_button_2, menu_prompt(&prompt)[MAX_MENU_PROMPTS] = menu_added_prompts);
