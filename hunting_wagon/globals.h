...
extern int menu_default_prompts_count, menu_added_prompts_count;
extern menu_prompt menu_default_prompts[MAX_MENU_PROMPTS];
...
extern Vector3 wagon_spawn_camp_coords, wagon_custom_spawn_coords;
extern Blip wagon_blip;
extern Hash wagon_vehicle_lantern;
extern Ped animal_holding, wagon_stow_entity, holding_entity;
extern Ped stowed_animals[10];

extern char* wagon_vehicle_hash;

extern float wagon_spawn_camp_heading, wagon_custom_spawn_heading;
...
wagon_bone, wagon_prompt, wagon_removal_prompt, wagon_menu_prompt, wagon_camp_menu_prompt, wagon_closest_camp, wagon_stow_time, wagon_request_time, wagon_override_door_request,
